...
type DefaultDeploymentStrategyAttrsRequest struct {
	...
	Firewall NullableInt32 `json:"firewall,omitempty"`
	CustomPage NullableInt32 `json:"custom_page,omitempty"`
}
...
// SetFirewall gets a reference to the given NullableInt32 and assigns it to the Firewall field.
...
// SetCustomPage gets a reference to the given NullableInt32 and assigns it to the CustomPage field.
