...
type TLSWorkloadRequest struct {
	...
	Ciphers *CiphersEnum `json:"ciphers,omitempty"`
...
func NewTLSWorkloadRequest() *TLSWorkloadRequest {
	...
	var minimumVersion TLSWorkloadMinimumVersion = tls_1_3
	this.MinimumVersion = *NewNullableTLSWorkloadMinimumVersion(&minimumVersion)
	return &this
}
...
// SetCiphers gets a reference to the given CiphersEnum and assigns it to the Ciphers field.
