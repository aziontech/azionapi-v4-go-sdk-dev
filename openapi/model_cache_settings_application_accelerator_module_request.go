...
type CacheSettingsApplicationAcceleratorModuleRequest struct {
	CacheVaryByMethod []CacheVaryByMethodEnum `json:"cache_vary_by_method,omitempty"`
...
func (o *CacheSettingsApplicationAcceleratorModuleRequest) GetCacheVaryByMethod() []CacheVaryByMethodEnum {
	if o == nil || IsNil(o.CacheVaryByMethod) {
		var ret []CacheVaryByMethodEnum
		return ret
	}
...
func (o *CacheSettingsApplicationAcceleratorModuleRequest) GetCacheVaryByMethodOk() ([]CacheVaryByMethodEnum, bool) {
	if o == nil || IsNil(o.CacheVaryByMethod) {
		return nil, false
	}
...
// SetCacheVaryByMethod gets a reference to the given []CacheVaryByMethodEnum and assigns it to the CacheVaryByMethod field.
func (o *CacheSettingsApplicationAcceleratorModuleRequest) SetCacheVaryByMethod(v []CacheVaryByMethodEnum) {
