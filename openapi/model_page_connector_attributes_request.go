...
type PageConnectorAttributesRequest struct {
	...
	CustomStatusCode NullableInt32 `json:"custom_status_code,omitempty"`
}
...
// SetCustomStatusCode gets a reference to the given NullableInt32 and assigns it to the CustomStatusCode field.
