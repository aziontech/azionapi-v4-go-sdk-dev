...
type MTLSConfigRequest struct {
	...
	Verification NullableVerificationEnum `json:"verification,omitempty"`
}
...
// SetVerification gets a reference to the given NullableVerificationEnum and assigns it to the Verification field.
