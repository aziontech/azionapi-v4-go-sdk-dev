...
type CacheSettingsEdgeCacheModuleRequest struct {
	Behavior *CacheSettingsEdgeCacheModuleBehaviorEnum `json:"behavior,omitempty"`
...
func NewCacheSettingsEdgeCacheModuleRequest() *CacheSettingsEdgeCacheModuleRequest {
	...
	var behavior CacheSettingsEdgeCacheModuleBehaviorEnum = honor
...
func (o *CacheSettingsEdgeCacheModuleRequest) GetBehavior() CacheSettingsEdgeCacheModuleBehaviorEnum {
	if o == nil || IsNil(o.Behavior) {
		var ret CacheSettingsEdgeCacheModuleBehaviorEnum
		return ret
	}
	return *o.Behavior
}
...
// SetBehavior gets a reference to the given CacheSettingsEdgeCacheModuleBehaviorEnum and assigns it to the Behavior field.
...
func (o *CacheSettingsEdgeCacheModuleRequest) SetTieredCacheNil() {
