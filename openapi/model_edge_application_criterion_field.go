...
// checks if the EdgeApplicationCriterionField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EdgeApplicationCriterionField{}
...
type EdgeApplicationCriterionField struct {
	...
	Variable EdgeApplicationCriterionFieldVariableEnum `json:"variable"`
...
func (o *EdgeApplicationCriterionField) GetVariable() EdgeApplicationCriterionFieldVariableEnum {
	if o == nil {
		var ret EdgeApplicationCriterionFieldVariableEnum
		return ret
	}
...
func (o *EdgeApplicationCriterionField) GetArgument() EdgeApplicationCriterionPolymorphicArgument {
	if o == nil || IsNil(o.Argument.Get()) {
		var ret EdgeApplicationCriterionPolymorphicArgument
		return ret
	}
...
// SetArgument gets a reference to the given NullableEdgeApplicationCriterionPolymorphicArgument and assigns it to the Argument field.
...
func (o *EdgeApplicationCriterionField) SetArgumentNil() {
	o.Argument.Set(nil)
}
...
func (o *EdgeApplicationCriterionField) UnmarshalJSON(data []byte) (err error) {
	...
	varEdgeApplicationCriterionField := _EdgeApplicationCriterionField{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEdgeApplicationCriterionField)

	if err != nil {
		return err
	}

	*o = EdgeApplicationCriterionField(varEdgeApplicationCriterionField)

	return err
}

type NullableEdgeApplicationCriterionField struct {
	value *EdgeApplicationCriterionField
	isSet bool
}

func (v NullableEdgeApplicationCriterionField) Get() *EdgeApplicationCriterionField {
	return v.value
}

func (v *NullableEdgeApplicationCriterionField) Set(val *EdgeApplicationCriterionField) {
	v.value = val
	v.isSet = true
}

func (v NullableEdgeApplicationCriterionField) IsSet() bool {
	return v.isSet
}

func (v *NullableEdgeApplicationCriterionField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEdgeApplicationCriterionField(val *EdgeApplicationCriterionField) *NullableEdgeApplicationCriterionField {
	return &NullableEdgeApplicationCriterionField{value: val, isSet: true}
}

func (v NullableEdgeApplicationCriterionField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEdgeApplicationCriterionField) UnmarshalJSON(src []byte) error {
	v.isSet = true
