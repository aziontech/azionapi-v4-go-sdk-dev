...
`func NewFirewallBehaviorRunFunction(type_ Type689Enum, attributes FirewallBehaviorRunFunctionAttributes, ) *FirewallBehaviorRunFunction`
...
`func (o *FirewallBehaviorRunFunction) GetType() Type689Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorRunFunction) GetTypeOk() (*Type689Enum, bool)`
...
`func (o *FirewallBehaviorRunFunction) SetType(v Type689Enum)`
