...
------------ | ------------- | ------------- | -------------
**Type** | [**ApplicationRuleEngineAddHeaderTypeEnum**](ApplicationRuleEngineAddHeaderTypeEnum.md) |  | 
...
`func NewApplicationRuleEngineAddHeaderRequest(type_ ApplicationRuleEngineAddHeaderTypeEnum, attributes ApplicationRuleEngineAddHeaderAttributesRequest, ) *ApplicationRuleEngineAddHeaderRequest`
...
`func (o *ApplicationRuleEngineAddHeaderRequest) GetType() ApplicationRuleEngineAddHeaderTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineAddHeaderRequest) GetTypeOk() (*ApplicationRuleEngineAddHeaderTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineAddHeaderRequest) SetType(v ApplicationRuleEngineAddHeaderTypeEnum)`
