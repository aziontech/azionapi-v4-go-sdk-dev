...
`func NewFirewallBehaviors(type_ Type689Enum, attributes FirewallBehaviorRunFunctionAttributes, ) *FirewallBehaviors`
...
`func (o *FirewallBehaviors) GetType() Type689Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviors) GetTypeOk() (*Type689Enum, bool)`
...
`func (o *FirewallBehaviors) SetType(v Type689Enum)`
