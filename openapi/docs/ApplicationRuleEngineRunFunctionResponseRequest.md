...
`func NewApplicationRuleEngineRunFunctionResponseRequest(type_ Type689Enum, attributes ApplicationRuleEngineRunFunctionResponseAttributesRequest, ) *ApplicationRuleEngineRunFunctionResponseRequest`
...
`func (o *ApplicationRuleEngineRunFunctionResponseRequest) GetType() Type689Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRunFunctionResponseRequest) GetTypeOk() (*Type689Enum, bool)`
...
`func (o *ApplicationRuleEngineRunFunctionResponseRequest) SetType(v Type689Enum)`
