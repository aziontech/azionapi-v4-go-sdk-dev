...
`func NewApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest(type_ ApplicationRuleEngineCaptureMatchGroupsTypeEnum, attributes ApplicationRuleEngineCaptureMatchGroupsAttributesRequest, ) *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest) GetType() ApplicationRuleEngineCaptureMatchGroupsTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest) GetTypeOk() (*ApplicationRuleEngineCaptureMatchGroupsTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest) SetType(v ApplicationRuleEngineCaptureMatchGroupsTypeEnum)`
