...
`func (o *PaginatedFirewallRuleEngineList) GetCount() int32`

GetCount returns the Count field if non-nil, zero value otherwise.

### GetCountOk

`func (o *PaginatedFirewallRuleEngineList) GetCountOk() (*int32, bool)`
...
`func (o *PaginatedFirewallRuleEngineList) SetCount(v int32)`
...
`func (o *PaginatedFirewallRuleEngineList) GetTotalPages() int32`

GetTotalPages returns the TotalPages field if non-nil, zero value otherwise.

### GetTotalPagesOk

`func (o *PaginatedFirewallRuleEngineList) GetTotalPagesOk() (*int32, bool)`
...
`func (o *PaginatedFirewallRuleEngineList) SetTotalPages(v int32)`

SetTotalPages sets TotalPages field to given value.

### HasTotalPages

`func (o *PaginatedFirewallRuleEngineList) HasTotalPages() bool`

HasTotalPages returns a boolean if a field has been set.

### GetPage

`func (o *PaginatedFirewallRuleEngineList) GetPage() int32`

GetPage returns the Page field if non-nil, zero value otherwise.

### GetPageOk

`func (o *PaginatedFirewallRuleEngineList) GetPageOk() (*int32, bool)`
...
`func (o *PaginatedFirewallRuleEngineList) SetPage(v int32)`

SetPage sets Page field to given value.

### HasPage

`func (o *PaginatedFirewallRuleEngineList) HasPage() bool`

HasPage returns a boolean if a field has been set.

### GetPageSize

`func (o *PaginatedFirewallRuleEngineList) GetPageSize() int32`

GetPageSize returns the PageSize field if non-nil, zero value otherwise.

### GetPageSizeOk

`func (o *PaginatedFirewallRuleEngineList) GetPageSizeOk() (*int32, bool)`
...
`func (o *PaginatedFirewallRuleEngineList) SetPageSize(v int32)`

SetPageSize sets PageSize field to given value.

### HasPageSize

`func (o *PaginatedFirewallRuleEngineList) HasPageSize() bool`
