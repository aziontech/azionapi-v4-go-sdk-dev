...
`func NewApplicationRuleEngineResponsePhaseBehaviors(type_ ApplicationRuleEngineCaptureMatchGroupsTypeEnum, attributes ApplicationRuleEngineCaptureMatchGroupsAttributes, ) *ApplicationRuleEngineResponsePhaseBehaviors`
...
`func (o *ApplicationRuleEngineResponsePhaseBehaviors) GetType() ApplicationRuleEngineCaptureMatchGroupsTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineResponsePhaseBehaviors) GetTypeOk() (*ApplicationRuleEngineCaptureMatchGroupsTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineResponsePhaseBehaviors) SetType(v ApplicationRuleEngineCaptureMatchGroupsTypeEnum)`
