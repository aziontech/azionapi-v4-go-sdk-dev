...
**Tls** | Pointer to [**TLSWorkloadRequest**](TLSWorkloadRequest.md) |  | [optional] [default to {}]
**Protocols** | Pointer to [**ProtocolsRequest**](ProtocolsRequest.md) |  | [optional] [default to {}]
**Mtls** | Pointer to [**MTLSRequest**](MTLSRequest.md) |  | [optional] [default to {"config":null}]
