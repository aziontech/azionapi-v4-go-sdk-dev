...
------------ | ------------- | ------------- | -------------
**Type** | [**FirewallBehaviorSetWafTypeEnum**](FirewallBehaviorSetWafTypeEnum.md) |  | 
...
`func NewFirewallBehaviorsFirewallBehaviorSetWafRequest(type_ FirewallBehaviorSetWafTypeEnum, attributes FirewallBehaviorSetWafAttributesRequest, ) *FirewallBehaviorsFirewallBehaviorSetWafRequest`
...
`func (o *FirewallBehaviorsFirewallBehaviorSetWafRequest) GetType() FirewallBehaviorSetWafTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorsFirewallBehaviorSetWafRequest) GetTypeOk() (*FirewallBehaviorSetWafTypeEnum, bool)`
...
`func (o *FirewallBehaviorsFirewallBehaviorSetWafRequest) SetType(v FirewallBehaviorSetWafTypeEnum)`
