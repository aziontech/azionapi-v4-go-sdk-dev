...
`func (o *DefaultDeploymentStrategyAttrsRequest) GetFirewall() int32`

GetFirewall returns the Firewall field if non-nil, zero value otherwise.

### GetFirewallOk

`func (o *DefaultDeploymentStrategyAttrsRequest) GetFirewallOk() (*int32, bool)`
...
`func (o *DefaultDeploymentStrategyAttrsRequest) SetFirewall(v int32)`
...
`func (o *DefaultDeploymentStrategyAttrsRequest) GetCustomPage() int32`

GetCustomPage returns the CustomPage field if non-nil, zero value otherwise.

### GetCustomPageOk

`func (o *DefaultDeploymentStrategyAttrsRequest) GetCustomPageOk() (*int32, bool)`
...
`func (o *DefaultDeploymentStrategyAttrsRequest) SetCustomPage(v int32)`
