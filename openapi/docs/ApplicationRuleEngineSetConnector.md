...
`func NewApplicationRuleEngineSetConnector(type_ ApplicationRuleEngineSetConnectorTypeEnum, attributes ApplicationRuleEngineSetConnectorAttributes, ) *ApplicationRuleEngineSetConnector`
...
`func (o *ApplicationRuleEngineSetConnector) GetType() ApplicationRuleEngineSetConnectorTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineSetConnector) GetTypeOk() (*ApplicationRuleEngineSetConnectorTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineSetConnector) SetType(v ApplicationRuleEngineSetConnectorTypeEnum)`
