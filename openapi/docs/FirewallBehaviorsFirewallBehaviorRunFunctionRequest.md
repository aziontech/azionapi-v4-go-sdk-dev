...
`func NewFirewallBehaviorsFirewallBehaviorRunFunctionRequest(type_ Type689Enum, attributes FirewallBehaviorRunFunctionAttributesRequest, ) *FirewallBehaviorsFirewallBehaviorRunFunctionRequest`
...
`func (o *FirewallBehaviorsFirewallBehaviorRunFunctionRequest) GetType() Type689Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorsFirewallBehaviorRunFunctionRequest) GetTypeOk() (*Type689Enum, bool)`
...
`func (o *FirewallBehaviorsFirewallBehaviorRunFunctionRequest) SetType(v Type689Enum)`
