...
------------ | ------------- | ------------- | -------------
**Functions** | Pointer to [**FirewallModuleRequest**](FirewallModuleRequest.md) |  | [optional] [default to {"enabled":true}]
**NetworkProtection** | Pointer to [**FirewallModuleRequest**](FirewallModuleRequest.md) |  | [optional] [default to {"enabled":true}]
**Waf** | Pointer to [**FirewallModuleRequest**](FirewallModuleRequest.md) |  | [optional] [default to {"enabled":false}]
