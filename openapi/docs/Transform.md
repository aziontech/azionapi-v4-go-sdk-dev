...
`func NewTransform(type_ string, attributes TransformRenderTemplate, ) *Transform`
...
`func (o *Transform) GetAttributes() TransformRenderTemplate`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *Transform) GetAttributesOk() (*TransformRenderTemplate, bool)`
...
`func (o *Transform) SetAttributes(v TransformRenderTemplate)`
