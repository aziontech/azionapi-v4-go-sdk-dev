...
`func (o *PaginatedWorkloadList) GetCount() int32`

GetCount returns the Count field if non-nil, zero value otherwise.

### GetCountOk

`func (o *PaginatedWorkloadList) GetCountOk() (*int32, bool)`
...
`func (o *PaginatedWorkloadList) SetCount(v int32)`
...
`func (o *PaginatedWorkloadList) GetTotalPages() int32`

GetTotalPages returns the TotalPages field if non-nil, zero value otherwise.

### GetTotalPagesOk

`func (o *PaginatedWorkloadList) GetTotalPagesOk() (*int32, bool)`
...
`func (o *PaginatedWorkloadList) SetTotalPages(v int32)`
...
`func (o *PaginatedWorkloadList) GetPage() int32`

GetPage returns the Page field if non-nil, zero value otherwise.

### GetPageOk

`func (o *PaginatedWorkloadList) GetPageOk() (*int32, bool)`
...
`func (o *PaginatedWorkloadList) SetPage(v int32)`
...
`func (o *PaginatedWorkloadList) GetPageSize() int32`

GetPageSize returns the PageSize field if non-nil, zero value otherwise.

### GetPageSizeOk

`func (o *PaginatedWorkloadList) GetPageSizeOk() (*int32, bool)`
...
`func (o *PaginatedWorkloadList) SetPageSize(v int32)`
