...
------------ | ------------- | ------------- | -------------
**Type** | [**FirewallBehaviorSetCustomResponseTypeEnum**](FirewallBehaviorSetCustomResponseTypeEnum.md) |  | 
...
`func NewFirewallBehaviorsFirewallBehaviorSetCustomResponseRequest(type_ FirewallBehaviorSetCustomResponseTypeEnum, attributes FirewallBehaviorSetCustomResponseAttributesRequest, ) *FirewallBehaviorsFirewallBehaviorSetCustomResponseRequest`
...
`func (o *FirewallBehaviorsFirewallBehaviorSetCustomResponseRequest) GetType() FirewallBehaviorSetCustomResponseTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorsFirewallBehaviorSetCustomResponseRequest) GetTypeOk() (*FirewallBehaviorSetCustomResponseTypeEnum, bool)`
...
`func (o *FirewallBehaviorsFirewallBehaviorSetCustomResponseRequest) SetType(v FirewallBehaviorSetCustomResponseTypeEnum)`
