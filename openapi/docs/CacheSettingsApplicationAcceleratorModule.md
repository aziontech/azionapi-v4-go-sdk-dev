...
------------ | ------------- | ------------- | -------------
**CacheVaryByMethod** | Pointer to [**[]CacheVaryByMethodEnum**](CacheVaryByMethodEnum.md) |  | [optional] 
...
`func (o *CacheSettingsApplicationAcceleratorModule) GetCacheVaryByMethod() []CacheVaryByMethodEnum`

GetCacheVaryByMethod returns the CacheVaryByMethod field if non-nil, zero value otherwise.

### GetCacheVaryByMethodOk

`func (o *CacheSettingsApplicationAcceleratorModule) GetCacheVaryByMethodOk() (*[]CacheVaryByMethodEnum, bool)`
...
`func (o *CacheSettingsApplicationAcceleratorModule) SetCacheVaryByMethod(v []CacheVaryByMethodEnum)`
