...
------------ | ------------- | ------------- | -------------
**LoadBalancer** | Pointer to [**LoadBalancerModuleRequest**](LoadBalancerModuleRequest.md) |  | [optional] [default to {"enabled":false,"config":null}]
**OriginShield** | Pointer to [**OriginShieldModuleRequest**](OriginShieldModuleRequest.md) |  | [optional] [default to {"enabled":false,"config":null}]
