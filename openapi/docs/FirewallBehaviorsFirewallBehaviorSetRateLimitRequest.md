...
------------ | ------------- | ------------- | -------------
**Type** | [**FirewallBehaviorSetRateLimitTypeEnum**](FirewallBehaviorSetRateLimitTypeEnum.md) |  | 
...
`func NewFirewallBehaviorsFirewallBehaviorSetRateLimitRequest(type_ FirewallBehaviorSetRateLimitTypeEnum, attributes FirewallBehaviorSetRateLimitAttributesRequest, ) *FirewallBehaviorsFirewallBehaviorSetRateLimitRequest`
...
`func (o *FirewallBehaviorsFirewallBehaviorSetRateLimitRequest) GetType() FirewallBehaviorSetRateLimitTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorsFirewallBehaviorSetRateLimitRequest) GetTypeOk() (*FirewallBehaviorSetRateLimitTypeEnum, bool)`
...
`func (o *FirewallBehaviorsFirewallBehaviorSetRateLimitRequest) SetType(v FirewallBehaviorSetRateLimitTypeEnum)`
