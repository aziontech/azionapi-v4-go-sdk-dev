...
`func NewAccount(id int64, name string, active bool, lastEditor string, lastModified time.Time, parentId int64, created time.Time, info map[string]map[string]interface{}, type_ string, status string, reason string, currencyIsoCode string, workspaceId string, ) *Account`
