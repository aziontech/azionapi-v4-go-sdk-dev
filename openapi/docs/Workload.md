...
**Tls** | Pointer to [**TLSWorkload**](TLSWorkload.md) |  | [optional] [default to {"certificate":null,"minimum_version":"tls_1_3"}]
...
**Mtls** | Pointer to [**MTLS**](MTLS.md) |  | [optional] [default to {"enabled":false,"config":null}]
**Domains** | Pointer to **[]string** |  | [optional] 
**WorkloadDomainAllowAccess** | Pointer to **bool** |  | [optional] 
**WorkloadDomain** | **string** |  | [readonly] [default to ""]
...
`func NewWorkload(id int32, name string, lastEditor string, lastModified time.Time, workloadDomain string, productVersion string, ) *Workload`
...
`func (o *Workload) GetInfrastructure() InfrastructureEnum`

GetInfrastructure returns the Infrastructure field if non-nil, zero value otherwise.

### GetInfrastructureOk

`func (o *Workload) GetInfrastructureOk() (*InfrastructureEnum, bool)`
...
`func (o *Workload) SetInfrastructure(v InfrastructureEnum)`
