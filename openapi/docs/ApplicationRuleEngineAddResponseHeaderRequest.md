...
`func NewApplicationRuleEngineAddResponseHeaderRequest(type_ ApplicationRuleEngineAddResponseHeaderTypeEnum, attributes ApplicationRuleEngineAddResponseHeaderAttributesRequest, ) *ApplicationRuleEngineAddResponseHeaderRequest`
...
`func (o *ApplicationRuleEngineAddResponseHeaderRequest) GetType() ApplicationRuleEngineAddResponseHeaderTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineAddResponseHeaderRequest) GetTypeOk() (*ApplicationRuleEngineAddResponseHeaderTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineAddResponseHeaderRequest) SetType(v ApplicationRuleEngineAddResponseHeaderTypeEnum)`
