...
`func NewFirewallBehaviorSetCustomResponseRequest(type_ FirewallBehaviorSetCustomResponseTypeEnum, attributes FirewallBehaviorSetCustomResponseAttributesRequest, ) *FirewallBehaviorSetCustomResponseRequest`
...
`func (o *FirewallBehaviorSetCustomResponseRequest) GetType() FirewallBehaviorSetCustomResponseTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorSetCustomResponseRequest) GetTypeOk() (*FirewallBehaviorSetCustomResponseTypeEnum, bool)`
...
`func (o *FirewallBehaviorSetCustomResponseRequest) SetType(v FirewallBehaviorSetCustomResponseTypeEnum)`
