...
`func NewConnectorHTTPRequest(name string, type_ Type15cEnum, attributes ConnectorHTTPAttributesRequest, ) *ConnectorHTTPRequest`
...
`func (o *ConnectorHTTPRequest) GetType() Type15cEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ConnectorHTTPRequest) GetTypeOk() (*Type15cEnum, bool)`
...
`func (o *ConnectorHTTPRequest) SetType(v Type15cEnum)`
