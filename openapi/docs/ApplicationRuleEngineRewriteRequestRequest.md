...
`func NewApplicationRuleEngineRewriteRequestRequest(type_ TypeF11Enum, attributes ApplicationRuleEngineRewriteRequestAttributesRequest, ) *ApplicationRuleEngineRewriteRequestRequest`
...
`func (o *ApplicationRuleEngineRewriteRequestRequest) GetType() TypeF11Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRewriteRequestRequest) GetTypeOk() (*TypeF11Enum, bool)`
...
`func (o *ApplicationRuleEngineRewriteRequestRequest) SetType(v TypeF11Enum)`
