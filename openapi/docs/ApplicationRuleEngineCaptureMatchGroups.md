...
`func NewApplicationRuleEngineCaptureMatchGroups(type_ ApplicationRuleEngineCaptureMatchGroupsTypeEnum, attributes ApplicationRuleEngineCaptureMatchGroupsAttributes, ) *ApplicationRuleEngineCaptureMatchGroups`
...
`func (o *ApplicationRuleEngineCaptureMatchGroups) GetType() ApplicationRuleEngineCaptureMatchGroupsTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineCaptureMatchGroups) GetTypeOk() (*ApplicationRuleEngineCaptureMatchGroupsTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineCaptureMatchGroups) SetType(v ApplicationRuleEngineCaptureMatchGroupsTypeEnum)`
