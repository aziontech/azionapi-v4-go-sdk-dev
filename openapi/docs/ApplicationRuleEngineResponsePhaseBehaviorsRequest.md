...
`func NewApplicationRuleEngineResponsePhaseBehaviorsRequest(type_ ApplicationRuleEngineCaptureMatchGroupsTypeEnum, attributes ApplicationRuleEngineCaptureMatchGroupsAttributesRequest, ) *ApplicationRuleEngineResponsePhaseBehaviorsRequest`
...
`func (o *ApplicationRuleEngineResponsePhaseBehaviorsRequest) GetType() ApplicationRuleEngineCaptureMatchGroupsTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineResponsePhaseBehaviorsRequest) GetTypeOk() (*ApplicationRuleEngineCaptureMatchGroupsTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineResponsePhaseBehaviorsRequest) SetType(v ApplicationRuleEngineCaptureMatchGroupsTypeEnum)`
