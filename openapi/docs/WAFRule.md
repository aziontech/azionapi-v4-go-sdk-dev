...
**Conditions** | [**[]WAFExceptionPolymorphicCondition**](WAFExceptionPolymorphicCondition.md) |  | 
...
`func NewWAFRule(id int32, name string, conditions []WAFExceptionPolymorphicCondition, lastEditor string, lastModified time.Time, ) *WAFRule`
...
`func (o *WAFRule) GetOperator() WAFRuleOperatorEnum`

GetOperator returns the Operator field if non-nil, zero value otherwise.

### GetOperatorOk

`func (o *WAFRule) GetOperatorOk() (*WAFRuleOperatorEnum, bool)`
...
`func (o *WAFRule) SetOperator(v WAFRuleOperatorEnum)`
