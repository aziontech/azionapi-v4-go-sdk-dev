...
`func NewApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetOriginRequest(type_ ApplicationRuleEngineSetOriginTypeEnum, attributes ApplicationRuleEngineSetOriginAttributesRequest, ) *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetOriginRequest`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetOriginRequest) GetType() ApplicationRuleEngineSetOriginTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetOriginRequest) GetTypeOk() (*ApplicationRuleEngineSetOriginTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetOriginRequest) SetType(v ApplicationRuleEngineSetOriginTypeEnum)`
