...
`func NewFirewallBehaviorSetWafRequest(type_ FirewallBehaviorSetWafTypeEnum, attributes FirewallBehaviorSetWafAttributesRequest, ) *FirewallBehaviorSetWafRequest`
...
`func (o *FirewallBehaviorSetWafRequest) GetType() FirewallBehaviorSetWafTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorSetWafRequest) GetTypeOk() (*FirewallBehaviorSetWafTypeEnum, bool)`
...
`func (o *FirewallBehaviorSetWafRequest) SetType(v FirewallBehaviorSetWafTypeEnum)`
