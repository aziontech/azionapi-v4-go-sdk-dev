...
`func NewApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineRunFunction(type_ Type689Enum, attributes ApplicationRuleEngineRunFunctionAttributes, ) *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineRunFunction`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineRunFunction) GetType() Type689Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineRunFunction) GetTypeOk() (*Type689Enum, bool)`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineRunFunction) SetType(v Type689Enum)`
