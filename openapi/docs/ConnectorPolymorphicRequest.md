...
`func NewConnectorPolymorphicRequest(name string, type_ Type15cEnum, attributes ConnectorLiveIngestAttributesRequest, ) *ConnectorPolymorphicRequest`
...
`func (o *ConnectorPolymorphicRequest) GetType() Type15cEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ConnectorPolymorphicRequest) GetTypeOk() (*Type15cEnum, bool)`
...
`func (o *ConnectorPolymorphicRequest) SetType(v Type15cEnum)`
