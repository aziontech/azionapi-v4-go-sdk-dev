...
func main() {
	workloadId := int32(56) // int32 | A unique integer value identifying the workload.
...
**workloadId** | **int32** | A unique integer value identifying the workload. | 
...
func main() {
	deploymentId := int32(56) // int32 | A unique integer value identifying the deployment.
	workloadId := int32(56) // int32 | A unique integer value identifying the workload.
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**deploymentId** | **int32** | A unique integer value identifying the deployment. | 
**workloadId** | **int32** | A unique integer value identifying the workload. | 
