...
`func NewApplicationRuleEngineSetCachePolicyRequest(type_ ApplicationRuleEngineSetCachePolicyTypeEnum, attributes ApplicationRuleEngineSetCachePolicyAttributesRequest, ) *ApplicationRuleEngineSetCachePolicyRequest`
...
`func (o *ApplicationRuleEngineSetCachePolicyRequest) GetType() ApplicationRuleEngineSetCachePolicyTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineSetCachePolicyRequest) GetTypeOk() (*ApplicationRuleEngineSetCachePolicyTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineSetCachePolicyRequest) SetType(v ApplicationRuleEngineSetCachePolicyTypeEnum)`
