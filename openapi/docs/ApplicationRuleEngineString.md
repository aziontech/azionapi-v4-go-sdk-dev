...
`func NewApplicationRuleEngineString(type_ ApplicationRuleEngineStringTypeEnum, attributes ApplicationRuleEngineStringAttributes, ) *ApplicationRuleEngineString`
...
`func (o *ApplicationRuleEngineString) GetType() ApplicationRuleEngineStringTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineString) GetTypeOk() (*ApplicationRuleEngineStringTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineString) SetType(v ApplicationRuleEngineStringTypeEnum)`
