...
`func NewNetworkListDetailRequest(name string, type_ Type528Enum, items []string, ) *NetworkListDetailRequest`
...
`func (o *NetworkListDetailRequest) GetType() Type528Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *NetworkListDetailRequest) GetTypeOk() (*Type528Enum, bool)`
...
`func (o *NetworkListDetailRequest) SetType(v Type528Enum)`
