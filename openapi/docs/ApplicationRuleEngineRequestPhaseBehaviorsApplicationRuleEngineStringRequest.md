...
`func NewApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineStringRequest(type_ ApplicationRuleEngineStringTypeEnum, attributes ApplicationRuleEngineStringAttributesRequest, ) *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineStringRequest`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineStringRequest) GetType() ApplicationRuleEngineStringTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineStringRequest) GetTypeOk() (*ApplicationRuleEngineStringTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineStringRequest) SetType(v ApplicationRuleEngineStringTypeEnum)`
