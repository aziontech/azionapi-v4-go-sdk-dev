...
`func NewApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetConnectorRequest(type_ ApplicationRuleEngineSetConnectorTypeEnum, attributes ApplicationRuleEngineSetConnectorAttributesRequest, ) *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetConnectorRequest`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetConnectorRequest) GetType() ApplicationRuleEngineSetConnectorTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetConnectorRequest) GetTypeOk() (*ApplicationRuleEngineSetConnectorTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineRequestPhaseBehaviorsApplicationRuleEngineSetConnectorRequest) SetType(v ApplicationRuleEngineSetConnectorTypeEnum)`
