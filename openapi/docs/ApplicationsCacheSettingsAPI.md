...
func main() {
	applicationId := int32(56) // int32 | A unique integer value identifying the application.
	cacheSettingId := int32(56) // int32 | A unique integer value identifying the cache setting.
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**applicationId** | **int32** | A unique integer value identifying the application. | 
**cacheSettingId** | **int32** | A unique integer value identifying the cache setting. | 
...
func main() {
	...
	browserCacheSettingsMaximumTtl := int32(56) // int32 | Filter by browser cache settings maximum TTL. (optional)
	...
	cdnCacheSettingsMaximumTtl := int32(56) // int32 | Filter by CDN cache settings maximum TTL. (optional)
	...
	sliceConfigurationRange := int32(56) // int32 | Filter by slice configuration range. (optional)
 ...
 **browserCacheSettingsMaximumTtl** | **int32** | Filter by browser cache settings maximum TTL. | 
 ...
 **cdnCacheSettingsMaximumTtl** | **int32** | Filter by CDN cache settings maximum TTL. | 
 ...
 **sliceConfigurationRange** | **int32** | Filter by slice configuration range. | 
