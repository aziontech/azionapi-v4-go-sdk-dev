...
`func NewFirewallBehaviorsFirewallBehaviorRunFunction(type_ Type689Enum, attributes FirewallBehaviorRunFunctionAttributes, ) *FirewallBehaviorsFirewallBehaviorRunFunction`
...
`func (o *FirewallBehaviorsFirewallBehaviorRunFunction) GetType() Type689Enum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorsFirewallBehaviorRunFunction) GetTypeOk() (*Type689Enum, bool)`
...
`func (o *FirewallBehaviorsFirewallBehaviorRunFunction) SetType(v Type689Enum)`
