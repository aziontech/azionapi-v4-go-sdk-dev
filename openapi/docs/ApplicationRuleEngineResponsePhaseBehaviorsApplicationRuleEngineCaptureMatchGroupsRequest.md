# ApplicationRuleEngineResponsePhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Type** | [**ApplicationRuleEngineCaptureMatchGroupsTypeEnum**](ApplicationRuleEngineCaptureMatchGroupsTypeEnum.md) |  | 
...
`func NewApplicationRuleEngineResponsePhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest(type_ ApplicationRuleEngineCaptureMatchGroupsTypeEnum, attributes ApplicationRuleEngineCaptureMatchGroupsAttributesRequest, ) *ApplicationRuleEngineResponsePhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest`
...
`func (o *ApplicationRuleEngineResponsePhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest) GetType() ApplicationRuleEngineCaptureMatchGroupsTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ApplicationRuleEngineResponsePhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest) GetTypeOk() (*ApplicationRuleEngineCaptureMatchGroupsTypeEnum, bool)`
...
`func (o *ApplicationRuleEngineResponsePhaseBehaviorsApplicationRuleEngineCaptureMatchGroupsRequest) SetType(v ApplicationRuleEngineCaptureMatchGroupsTypeEnum)`
