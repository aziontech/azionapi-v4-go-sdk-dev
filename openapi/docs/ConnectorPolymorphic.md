...
`func NewConnectorPolymorphic(id int32, name string, lastEditor string, lastModified time.Time, productVersion string, type_ Type15cEnum, attributes ConnectorLiveIngestAttributes, ) *ConnectorPolymorphic`
...
`func (o *ConnectorPolymorphic) GetId() int32`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *ConnectorPolymorphic) GetIdOk() (*int32, bool)`
...
`func (o *ConnectorPolymorphic) SetId(v int32)`
...
`func (o *ConnectorPolymorphic) GetType() Type15cEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *ConnectorPolymorphic) GetTypeOk() (*Type15cEnum, bool)`
...
`func (o *ConnectorPolymorphic) SetType(v Type15cEnum)`
