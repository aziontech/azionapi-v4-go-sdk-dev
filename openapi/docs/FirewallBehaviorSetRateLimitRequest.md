...
`func NewFirewallBehaviorSetRateLimitRequest(type_ FirewallBehaviorSetRateLimitTypeEnum, attributes FirewallBehaviorSetRateLimitAttributesRequest, ) *FirewallBehaviorSetRateLimitRequest`
...
`func (o *FirewallBehaviorSetRateLimitRequest) GetType() FirewallBehaviorSetRateLimitTypeEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *FirewallBehaviorSetRateLimitRequest) GetTypeOk() (*FirewallBehaviorSetRateLimitTypeEnum, bool)`
...
`func (o *FirewallBehaviorSetRateLimitRequest) SetType(v FirewallBehaviorSetRateLimitTypeEnum)`
