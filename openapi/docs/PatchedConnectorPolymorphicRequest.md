...
`func (o *PatchedConnectorPolymorphicRequest) GetType() Type15cEnum`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *PatchedConnectorPolymorphicRequest) GetTypeOk() (*Type15cEnum, bool)`
...
`func (o *PatchedConnectorPolymorphicRequest) SetType(v Type15cEnum)`
