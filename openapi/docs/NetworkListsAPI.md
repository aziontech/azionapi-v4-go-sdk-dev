...
func main() {
	networkListDetailRequest := *openapiclient.NewNetworkListDetailRequest("Name_example", *openapiclient.NewType528Enum(), []string{"Items_example"}) // NetworkListDetailRequest | 
...
func main() {
	networkListId := int32(56) // int32 | A unique integer value identifying the network list.
...
**networkListId** | **int32** | A unique integer value identifying the network list. | 
...
func main() {
	accountId := int32(56) // int32 | Filter by account ID. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **accountId** | **int32** | Filter by account ID. | 
