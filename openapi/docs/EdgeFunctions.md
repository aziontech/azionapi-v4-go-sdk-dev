...
`func NewEdgeFunctions(id int32, name string, lastEditor string, lastModified time.Time, productVersion string, code string, referenceCount int32, version string, vendor string, ) *EdgeFunctions`
...
`func (o *EdgeFunctions) GetRuntime() RuntimeEnum`

GetRuntime returns the Runtime field if non-nil, zero value otherwise.

### GetRuntimeOk

`func (o *EdgeFunctions) GetRuntimeOk() (*RuntimeEnum, bool)`
...
`func (o *EdgeFunctions) SetRuntime(v RuntimeEnum)`
...
`func (o *EdgeFunctions) GetExecutionEnvironment() ExecutionEnvironmentEnum`

GetExecutionEnvironment returns the ExecutionEnvironment field if non-nil, zero value otherwise.

### GetExecutionEnvironmentOk

`func (o *EdgeFunctions) GetExecutionEnvironmentOk() (*ExecutionEnvironmentEnum, bool)`
...
`func (o *EdgeFunctions) SetExecutionEnvironment(v ExecutionEnvironmentEnum)`
...
`func (o *EdgeFunctions) GetAzionForm() ApplicationFunctionInstanceAzionForm`

GetAzionForm returns the AzionForm field if non-nil, zero value otherwise.

### GetAzionFormOk

`func (o *EdgeFunctions) GetAzionFormOk() (*ApplicationFunctionInstanceAzionForm, bool)`
...
`func (o *EdgeFunctions) SetAzionForm(v ApplicationFunctionInstanceAzionForm)`
