...
func NewConnectorHTTPAttributesRequest(addresses []AddressRequest) *ConnectorHTTPAttributesRequest {
	...
	var connectionOptions HTTPConnectionOptionsRequest = {"dns_resolution":"both","transport_policy":"preserve","http_version_policy":"http1_1","host":"${host}","path_prefix":"","following_redirect":false,"real_ip_header":"X-Real-IP","real_port_header":"X-Real-PORT"}
	this.ConnectionOptions = &connectionOptions
	var modules HTTPModulesRequest = {"load_balancer":{"enabled":false,"config":null},"origin_shield":{"enabled":false,"config":null}}
