...
type LoadBalancerModuleConfig struct {
	...
	ReadWriteTimeout *int32 `json:"read_write_timeout,omitempty"`
}
...
func NewLoadBalancerModuleConfig() *LoadBalancerModuleConfig {
	...
	var method MethodEnum = round_robin
	this.Method = &method
	var maxRetries int32 = 0
	this.MaxRetries = &maxRetries
	var connectionTimeout int32 = 60
	this.ConnectionTimeout = &connectionTimeout
	var readWriteTimeout int32 = 120
...
// SetReadWriteTimeout gets a reference to the given int32 and assigns it to the ReadWriteTimeout field.
