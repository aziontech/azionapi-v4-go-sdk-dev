...
type PatchedWAFRuleRequest struct {
	...
	Operator *WAFRuleOperatorEnum `json:"operator,omitempty"`
...
func NewPatchedWAFRuleRequest() *PatchedWAFRuleRequest {
	...
	this.RuleId = &ruleId
	var operator WAFRuleOperatorEnum = contains
...
// SetOperator gets a reference to the given WAFRuleOperatorEnum and assigns it to the Operator field.
