...
type PatchedWAFRuleRequest struct {
	...
	Conditions []WAFExceptionConditionRequest `json:"conditions,omitempty"`
...
func (o *PatchedWAFRuleRequest) GetConditions() []WAFExceptionConditionRequest {
	if o == nil || IsNil(o.Conditions) {
		var ret []WAFExceptionConditionRequest
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []WAFExceptionConditionRequest and assigns it to the Conditions field.
