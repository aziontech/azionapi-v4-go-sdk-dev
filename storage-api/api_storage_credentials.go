...
*/
func (a *StorageCredentialsAPIService) DeleteCredential(ctx context.Context, id string) ApiDeleteCredentialRequest {
	return ApiDeleteCredentialRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *StorageCredentialsAPIService) DeleteCredentialExecute(r ApiDeleteCredentialRequest) (*ResponseDeleteCredential, *http.Response, error) {
	var (
...
*/
func (a *StorageCredentialsAPIService) RetrieveCredential(ctx context.Context, id string) ApiRetrieveCredentialRequest {
	return ApiRetrieveCredentialRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *StorageCredentialsAPIService) RetrieveCredentialExecute(r ApiRetrieveCredentialRequest) (*ResponseRetrieveCredential, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
