...
func (a *StorageBucketsAPIService) DeleteBucketExecute(r ApiDeleteBucketRequest) (*ResponseDeleteBucketCreate, *http.Response, error) {
	var (
...
func (a *StorageBucketsAPIService) RetrieveBucketExecute(r ApiRetrieveBucketRequest) (*ResponseRetrieveBucket, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
