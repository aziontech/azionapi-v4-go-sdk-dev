...
// checks if the PaginatedReportListResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedReportListResponseList{}

// PaginatedReportListResponseList struct for PaginatedReportListResponseList
type PaginatedReportListResponseList struct {
	...
	Results []ReportListResponse `json:"results,omitempty"`
}
...
func NewPaginatedReportListResponseList() *PaginatedReportListResponseList {
	this := PaginatedReportListResponseList{}
	return &this
}
...
func (o *PaginatedReportListResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedReportListResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []ReportListResponse and assigns it to the Results field.
func (o *PaginatedReportListResponseList) SetResults(v []ReportListResponse) {
	o.Results = v
}

func (o PaginatedReportListResponseList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedReportListResponseList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedReportListResponseList struct {
	value *PaginatedReportListResponseList
	isSet bool
}

func (v NullablePaginatedReportListResponseList) Get() *PaginatedReportListResponseList {
	return v.value
}

func (v *NullablePaginatedReportListResponseList) Set(val *PaginatedReportListResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedReportListResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedReportListResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedReportListResponseList(val *PaginatedReportListResponseList) *NullablePaginatedReportListResponseList {
	return &NullablePaginatedReportListResponseList{value: val, isSet: true}
}

func (v NullablePaginatedReportListResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedReportListResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
