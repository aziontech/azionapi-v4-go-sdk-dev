...
func (a *MetricsLibraryReportsAPIService) DeleteLibraryReportExecute(r ApiDeleteLibraryReportRequest) (*ResponseDeleteReport, *http.Response, error) {
	...
	localVarPath := localBasePath + "/metrics/library/reports/{library_report_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"library_report_id"+"}", url.PathEscape(parameterValueToString(r.libraryReportId, "libraryReportId")), -1)
...
func (r ApiListLibraryReportsRequest) Page(page int32) ApiListLibraryReportsRequest {
	r.page = &page
	return r
}

// A numeric value that indicates the number of items per page.
func (r ApiListLibraryReportsRequest) PageSize(pageSize int32) ApiListLibraryReportsRequest {
	r.pageSize = &pageSize
	return r
}
...
func (r ApiListLibraryReportsRequest) Execute() (*PaginatedReportList, *http.Response, error) {
...
func (a *MetricsLibraryReportsAPIService) ListLibraryReportsExecute(r ApiListLibraryReportsRequest) (*PaginatedReportList, *http.Response, error) {
	var (
