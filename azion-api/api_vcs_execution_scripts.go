...
func (r ApiListExecutionScriptsRequest) Page(page int32) ApiListExecutionScriptsRequest {
	r.page = &page
	return r
}

// A numeric value that indicates the number of items per page.
func (r ApiListExecutionScriptsRequest) PageSize(pageSize int32) ApiListExecutionScriptsRequest {
	r.pageSize = &pageSize
	return r
}
...
func (r ApiListExecutionScriptsRequest) Execute() (*PaginatedExecutionScriptList, *http.Response, error) {
...
//  @return PaginatedExecutionScriptList
func (a *VCSExecutionScriptsAPIService) ListExecutionScriptsExecute(r ApiListExecutionScriptsRequest) (*PaginatedExecutionScriptList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PaginatedExecutionScriptList
	)
