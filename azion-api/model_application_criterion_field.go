...
func NewApplicationCriterionField(conditional string, variable string, operator string) *ApplicationCriterionField {
	this := ApplicationCriterionField{}
...
func (o *ApplicationCriterionField) SetArgumentNil() {
	o.Argument.Set(nil)
}
...
func (o ApplicationCriterionField) MarshalJSON() ([]byte, error) {
...
func (o ApplicationCriterionField) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationCriterionField) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ApplicationCriterionField(varApplicationCriterionField)

	return err
}

type NullableApplicationCriterionField struct {
	value *ApplicationCriterionField
	isSet bool
}

func (v NullableApplicationCriterionField) Get() *ApplicationCriterionField {
	return v.value
}

func (v *NullableApplicationCriterionField) Set(val *ApplicationCriterionField) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationCriterionField) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationCriterionField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationCriterionField(val *ApplicationCriterionField) *NullableApplicationCriterionField {
	return &NullableApplicationCriterionField{value: val, isSet: true}
}

func (v NullableApplicationCriterionField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationCriterionField) UnmarshalJSON(src []byte) error {
	v.isSet = true
