...
func (r ApiListDescendantsAccountsRequest) Execute() (*PaginatedAccountList, *http.Response, error) {
...
func (a *AccountsDescendantsAPIService) ListDescendantsAccountsExecute(r ApiListDescendantsAccountsRequest) (*PaginatedAccountList, *http.Response, error) {
	var (
