...
type ApplicationModulesRequest struct {
	...
	Functions *FunctionModuleRequest `json:"functions,omitempty"`
...
// SetFunctions gets a reference to the given FunctionModuleRequest and assigns it to the Functions field.
