...
// checks if the PaginatedDashboardList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedDashboardList{}

// PaginatedDashboardList struct for PaginatedDashboardList
...
func (o PaginatedDashboardList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedDashboardList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedDashboardList struct {
	value *PaginatedDashboardList
	isSet bool
}

func (v NullablePaginatedDashboardList) Get() *PaginatedDashboardList {
	return v.value
}

func (v *NullablePaginatedDashboardList) Set(val *PaginatedDashboardList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedDashboardList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedDashboardList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedDashboardList(val *PaginatedDashboardList) *NullablePaginatedDashboardList {
	return &NullablePaginatedDashboardList{value: val, isSet: true}
}

func (v NullablePaginatedDashboardList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedDashboardList) UnmarshalJSON(src []byte) error {
	v.isSet = true
