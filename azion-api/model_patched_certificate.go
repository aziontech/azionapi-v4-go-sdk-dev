...
// PatchedCertificate Certificate payload with build state fields (``version_id``, ``version_state``).
...
func (o *PatchedCertificate) SetCertificateNil() {
...
func (o *PatchedCertificate) SetIssuerNil() {
	o.Issuer.Set(nil)
}
...
func (o *PatchedCertificate) SetCsrNil() {
	o.Csr.Set(nil)
}
...
func (o *PatchedCertificate) SetRenewedAtNil() {
	o.RenewedAt.Set(nil)
}
...
func (o *PatchedCertificate) SetVersionStateNil() {
...
func (o PatchedCertificate) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedCertificate struct {
	value *PatchedCertificate
	isSet bool
}

func (v NullablePatchedCertificate) Get() *PatchedCertificate {
	return v.value
}

func (v *NullablePatchedCertificate) Set(val *PatchedCertificate) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedCertificate) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedCertificate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedCertificate(val *PatchedCertificate) *NullablePatchedCertificate {
	return &NullablePatchedCertificate{value: val, isSet: true}
}

func (v NullablePatchedCertificate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedCertificate) UnmarshalJSON(src []byte) error {
	v.isSet = true
