...
`func NewSplunkEndpointRequest(url string, apiKey string, type_ string, ) *SplunkEndpointRequest`
...
`func (o *SplunkEndpointRequest) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *SplunkEndpointRequest) GetTypeOk() (*string, bool)`
...
`func (o *SplunkEndpointRequest) SetType(v string)`
