...
`func NewTransformRequest(type_ string, attributes TransformRenderTemplateRequest, ) *TransformRequest`
...
`func (o *TransformRequest) GetAttributes() TransformRenderTemplateRequest`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *TransformRequest) GetAttributesOk() (*TransformRenderTemplateRequest, bool)`
...
`func (o *TransformRequest) SetAttributes(v TransformRenderTemplateRequest)`
