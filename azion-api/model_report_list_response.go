...
var _ MappedNullable = &ReportListResponse{}

// ReportListResponse struct for ReportListResponse
...
type _ReportListResponse ReportListResponse
...
func (o *ReportListResponse) SetHelpCenterPathNil() {
...
func (o ReportListResponse) MarshalJSON() ([]byte, error) {
...
func (o ReportListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableReportListResponse struct {
	value *ReportListResponse
	isSet bool
}

func (v NullableReportListResponse) Get() *ReportListResponse {
	return v.value
}

func (v *NullableReportListResponse) Set(val *ReportListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReportListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReportListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportListResponse(val *ReportListResponse) *NullableReportListResponse {
	return &NullableReportListResponse{value: val, isSet: true}
}

func (v NullableReportListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
