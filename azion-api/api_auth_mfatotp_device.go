...
func (a *AuthMFATOTPDeviceAPIService) CreateTotpDeviceExecute(r ApiCreateTotpDeviceRequest) (*TOTPDeviceResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/account/auth/mfa/totp"
...
func (r ApiListTotpDevicesRequest) Execute() (*PaginatedTOTPDeviceList, *http.Response, error) {
...
func (a *AuthMFATOTPDeviceAPIService) ListTotpDevicesExecute(r ApiListTotpDevicesRequest) (*PaginatedTOTPDeviceList, *http.Response, error) {
	var (
