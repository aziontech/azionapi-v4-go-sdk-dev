...
// checks if the PaginatedReportList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedReportList{}
...
func (o PaginatedReportList) ToMap() (map[string]interface{}, error) {
