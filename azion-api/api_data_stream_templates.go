...
func (r ApiDeleteTemplateRequest) Execute() (*DeleteResponse, *http.Response, error) {
...
func (a *DataStreamTemplatesAPIService) DeleteTemplateExecute(r ApiDeleteTemplateRequest) (*DeleteResponse, *http.Response, error) {
	var (
