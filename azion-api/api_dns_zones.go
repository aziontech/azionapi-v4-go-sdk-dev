...
func (a *DNSZonesAPIService) CreateDnsZoneExecute(r ApiCreateDnsZoneRequest) (*ZoneResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/workspace/dns/zones"
...
func (a *DNSZonesAPIService) DeleteDnsZoneExecute(r ApiDeleteDnsZoneRequest) (*DeleteResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/workspace/dns/zones/{zone_id}"
...
func (r ApiListDnsZonesRequest) Page(page int32) ApiListDnsZonesRequest {
	r.page = &page
	return r
}

// A numeric value that indicates the number of items per page.
func (r ApiListDnsZonesRequest) PageSize(pageSize int32) ApiListDnsZonesRequest {
	r.pageSize = &pageSize
	return r
}
