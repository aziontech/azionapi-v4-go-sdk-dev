...
// checks if the CacheSettingResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CacheSettingResponse{}
...
func (o CacheSettingResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CacheSettingResponse) UnmarshalJSON(data []byte) (err error) {
