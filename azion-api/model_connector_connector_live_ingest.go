...
// checks if the ConnectorConnectorLiveIngest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorConnectorLiveIngest{}

// ConnectorConnectorLiveIngest struct for ConnectorConnectorLiveIngest
type ConnectorConnectorLiveIngest struct {
...
type _ConnectorConnectorLiveIngest ConnectorConnectorLiveIngest
...
func NewConnectorConnectorLiveIngest(type_ string, id int64, name string, lastEditor string, lastModified time.Time, createdAt time.Time, productVersion string, isVersioned bool, version NullableInt64, versionState NullableString, attributes ConnectorLiveIngestAttributes) *ConnectorConnectorLiveIngest {
	this := ConnectorConnectorLiveIngest{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o ConnectorConnectorLiveIngest) MarshalJSON() ([]byte, error) {
...
func (o ConnectorConnectorLiveIngest) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorConnectorLiveIngest) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectorConnectorLiveIngest := _ConnectorConnectorLiveIngest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varConnectorConnectorLiveIngest)

	if err != nil {
		return err
	}

	*o = ConnectorConnectorLiveIngest(varConnectorConnectorLiveIngest)

	return err
}

type NullableConnectorConnectorLiveIngest struct {
	value *ConnectorConnectorLiveIngest
	isSet bool
}

func (v NullableConnectorConnectorLiveIngest) Get() *ConnectorConnectorLiveIngest {
	return v.value
}

func (v *NullableConnectorConnectorLiveIngest) Set(val *ConnectorConnectorLiveIngest) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorConnectorLiveIngest) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorConnectorLiveIngest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorConnectorLiveIngest(val *ConnectorConnectorLiveIngest) *NullableConnectorConnectorLiveIngest {
	return &NullableConnectorConnectorLiveIngest{value: val, isSet: true}
}

func (v NullableConnectorConnectorLiveIngest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorConnectorLiveIngest) UnmarshalJSON(src []byte) error {
	v.isSet = true
