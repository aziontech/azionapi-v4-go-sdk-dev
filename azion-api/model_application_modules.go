...
type ApplicationModules struct {
	...
	Functions *FunctionModule `json:"functions,omitempty"`
...
// SetFunctions gets a reference to the given FunctionModule and assigns it to the Functions field.
