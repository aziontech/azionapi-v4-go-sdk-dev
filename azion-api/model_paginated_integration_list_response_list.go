...
// checks if the PaginatedIntegrationListResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedIntegrationListResponseList{}

// PaginatedIntegrationListResponseList struct for PaginatedIntegrationListResponseList
type PaginatedIntegrationListResponseList struct {
	...
	Results []IntegrationListResponse `json:"results,omitempty"`
}
...
func NewPaginatedIntegrationListResponseList() *PaginatedIntegrationListResponseList {
	this := PaginatedIntegrationListResponseList{}
	return &this
}
...
func (o *PaginatedIntegrationListResponseList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedIntegrationListResponseList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o *PaginatedIntegrationListResponseList) GetResults() []IntegrationListResponse {
	if o == nil || IsNil(o.Results) {
		var ret []IntegrationListResponse
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []IntegrationListResponse and assigns it to the Results field.
func (o *PaginatedIntegrationListResponseList) SetResults(v []IntegrationListResponse) {
	o.Results = v
}

func (o PaginatedIntegrationListResponseList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedIntegrationListResponseList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedIntegrationListResponseList struct {
	value *PaginatedIntegrationListResponseList
	isSet bool
}

func (v NullablePaginatedIntegrationListResponseList) Get() *PaginatedIntegrationListResponseList {
	return v.value
}

func (v *NullablePaginatedIntegrationListResponseList) Set(val *PaginatedIntegrationListResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedIntegrationListResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedIntegrationListResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedIntegrationListResponseList(val *PaginatedIntegrationListResponseList) *NullablePaginatedIntegrationListResponseList {
	return &NullablePaginatedIntegrationListResponseList{value: val, isSet: true}
}

func (v NullablePaginatedIntegrationListResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedIntegrationListResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
