...
type ApiCreateApplicationFunctionInstance2Request struct {
	ctx context.Context
	ApiService *ApplicationsFunctionAPIService
	applicationId int64
	versionId string
...
func (r ApiCreateApplicationFunctionInstance2Request) FunctionInstanceRequest(functionInstanceRequest FunctionInstanceRequest) ApiCreateApplicationFunctionInstance2Request {
	r.functionInstanceRequest = &functionInstanceRequest
	return r
}

func (r ApiCreateApplicationFunctionInstance2Request) Execute() (*FunctionInstanceResponse, *http.Response, error) {
	return r.ApiService.CreateApplicationFunctionInstance2Execute(r)
}

/*
CreateApplicationFunctionInstance2 Create an Application Function Instance
...
Create a new Function Instance for a specific Application in your account.
 ...
 @return ApiCreateApplicationFunctionInstance2Request
*/
func (a *ApplicationsFunctionAPIService) CreateApplicationFunctionInstance2(ctx context.Context, applicationId int64, versionId string) ApiCreateApplicationFunctionInstance2Request {
	return ApiCreateApplicationFunctionInstance2Request{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return FunctionInstanceResponse
func (a *ApplicationsFunctionAPIService) CreateApplicationFunctionInstance2Execute(r ApiCreateApplicationFunctionInstance2Request) (*FunctionInstanceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsFunctionAPIService.CreateApplicationFunctionInstance2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/workspace/applications/{application_id}/versions/{version_id}/functions"
	localVarPath = strings.Replace(localVarPath, "{"+"application_id"+"}", url.PathEscape(parameterValueToString(r.applicationId, "applicationId")), -1)
...
type ApiDeleteApplicationFunctionInstance2Request struct {
	ctx context.Context
	ApiService *ApplicationsFunctionAPIService
	applicationId int64
	functionId int64
...
func (r ApiDeleteApplicationFunctionInstance2Request) Execute() (*DeleteResponse, *http.Response, error) {
	return r.ApiService.DeleteApplicationFunctionInstance2Execute(r)
}

/*
DeleteApplicationFunctionInstance2 Delete an Application Function Instance
...
Delete a specific Application Function Instance in your account.
 ...
 @param functionId A unique integer value identifying the function instance.
 @param versionId The ULID identifier of the version.
 @return ApiDeleteApplicationFunctionInstance2Request
*/
func (a *ApplicationsFunctionAPIService) DeleteApplicationFunctionInstance2(ctx context.Context, applicationId int64, functionId int64, versionId string) ApiDeleteApplicationFunctionInstance2Request {
	return ApiDeleteApplicationFunctionInstance2Request{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return DeleteResponse
func (a *ApplicationsFunctionAPIService) DeleteApplicationFunctionInstance2Execute(r ApiDeleteApplicationFunctionInstance2Request) (*DeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsFunctionAPIService.DeleteApplicationFunctionInstance2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/workspace/applications/{application_id}/versions/{version_id}/functions/{function_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"application_id"+"}", url.PathEscape(parameterValueToString(r.applicationId, "applicationId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"function_id"+"}", url.PathEscape(parameterValueToString(r.functionId, "functionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version_id"+"}", url.PathEscape(parameterValueToString(r.versionId, "versionId")), -1)
...
type ApiListApplicationFunctionInstances2Request struct {
	ctx context.Context
	ApiService *ApplicationsFunctionAPIService
	applicationId int64
	versionId string
...
// Comma-separated list of field names to include in the response. Nested fields can be accessed using dot notation.
func (r ApiListApplicationFunctionInstances2Request) Fields(fields string) ApiListApplicationFunctionInstances2Request {
	r.fields = &fields
	return r
}

// Filter by id (accepts comma-separated values).
func (r ApiListApplicationFunctionInstances2Request) Id(id int64) ApiListApplicationFunctionInstances2Request {
	r.id = &id
	return r
}

// Filter by last editor (case-insensitive, partial match).
func (r ApiListApplicationFunctionInstances2Request) LastEditor(lastEditor string) ApiListApplicationFunctionInstances2Request {
	r.lastEditor = &lastEditor
	return r
}

// Filter by last modified date (greater than or equal).
func (r ApiListApplicationFunctionInstances2Request) LastModifiedGte(lastModifiedGte time.Time) ApiListApplicationFunctionInstances2Request {
	r.lastModifiedGte = &lastModifiedGte
	return r
}

// Filter by last modified date (less than or equal).
func (r ApiListApplicationFunctionInstances2Request) LastModifiedLte(lastModifiedLte time.Time) ApiListApplicationFunctionInstances2Request {
	r.lastModifiedLte = &lastModifiedLte
	return r
}

// Filter by name (case-insensitive, partial match).
func (r ApiListApplicationFunctionInstances2Request) Name(name string) ApiListApplicationFunctionInstances2Request {
	r.name = &name
	return r
}

// Which field to use when ordering the results.
func (r ApiListApplicationFunctionInstances2Request) Ordering(ordering string) ApiListApplicationFunctionInstances2Request {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiListApplicationFunctionInstances2Request) Page(page int64) ApiListApplicationFunctionInstances2Request {
	r.page = &page
	return r
}

// A numeric value that indicates the number of items per page.
func (r ApiListApplicationFunctionInstances2Request) PageSize(pageSize int64) ApiListApplicationFunctionInstances2Request {
	r.pageSize = &pageSize
	return r
}

// A search term.
func (r ApiListApplicationFunctionInstances2Request) Search(search string) ApiListApplicationFunctionInstances2Request {
	r.search = &search
	return r
}

func (r ApiListApplicationFunctionInstances2Request) Execute() (*PaginatedFunctionInstanceList, *http.Response, error) {
	return r.ApiService.ListApplicationFunctionInstances2Execute(r)
}

/*
ListApplicationFunctionInstances2 List Function Instances
...
List all Function Instances for a specific Application owned by your account.
 ...
 @param applicationId A unique integer value identifying the application.
 @param versionId The ULID identifier of the version.
 @return ApiListApplicationFunctionInstances2Request
*/
func (a *ApplicationsFunctionAPIService) ListApplicationFunctionInstances2(ctx context.Context, applicationId int64, versionId string) ApiListApplicationFunctionInstances2Request {
	return ApiListApplicationFunctionInstances2Request{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return PaginatedFunctionInstanceList
func (a *ApplicationsFunctionAPIService) ListApplicationFunctionInstances2Execute(r ApiListApplicationFunctionInstances2Request) (*PaginatedFunctionInstanceList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsFunctionAPIService.ListApplicationFunctionInstances2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPartialUpdateApplicationFunctionInstance2Request struct {
	ctx context.Context
	ApiService *ApplicationsFunctionAPIService
	applicationId int64
	functionId int64
...
func (r ApiPartialUpdateApplicationFunctionInstance2Request) PatchedFunctionInstanceRequest(patchedFunctionInstanceRequest PatchedFunctionInstanceRequest) ApiPartialUpdateApplicationFunctionInstance2Request {
	r.patchedFunctionInstanceRequest = &patchedFunctionInstanceRequest
	return r
}

func (r ApiPartialUpdateApplicationFunctionInstance2Request) Execute() (*FunctionInstanceResponse, *http.Response, error) {
	return r.ApiService.PartialUpdateApplicationFunctionInstance2Execute(r)
}

/*
PartialUpdateApplicationFunctionInstance2 Partially update an Application Function Instance
...
Update one or more fields of an existing Application Function Instance without affecting other fields.
 ...
 @param functionId A unique integer value identifying the function instance.
 @param versionId The ULID identifier of the version.
 @return ApiPartialUpdateApplicationFunctionInstance2Request
*/
func (a *ApplicationsFunctionAPIService) PartialUpdateApplicationFunctionInstance2(ctx context.Context, applicationId int64, functionId int64, versionId string) ApiPartialUpdateApplicationFunctionInstance2Request {
	return ApiPartialUpdateApplicationFunctionInstance2Request{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return FunctionInstanceResponse
func (a *ApplicationsFunctionAPIService) PartialUpdateApplicationFunctionInstance2Execute(r ApiPartialUpdateApplicationFunctionInstance2Request) (*FunctionInstanceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsFunctionAPIService.PartialUpdateApplicationFunctionInstance2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRetrieveApplicationFunctionInstance2Request struct {
	ctx context.Context
	ApiService *ApplicationsFunctionAPIService
	applicationId int64
	functionId int64
...
// Comma-separated list of field names to include in the response. Nested fields can be accessed using dot notation.
func (r ApiRetrieveApplicationFunctionInstance2Request) Fields(fields string) ApiRetrieveApplicationFunctionInstance2Request {
	r.fields = &fields
	return r
}

func (r ApiRetrieveApplicationFunctionInstance2Request) Execute() (*FunctionInstanceResponse, *http.Response, error) {
	return r.ApiService.RetrieveApplicationFunctionInstance2Execute(r)
}

/*
RetrieveApplicationFunctionInstance2 Retrieve details of an Application Function Instance
...
Retrieve details of a specific Application Function Instance in your account.
 ...
 @param functionId A unique integer value identifying the function instance.
 @param versionId The ULID identifier of the version.
 @return ApiRetrieveApplicationFunctionInstance2Request
*/
func (a *ApplicationsFunctionAPIService) RetrieveApplicationFunctionInstance2(ctx context.Context, applicationId int64, functionId int64, versionId string) ApiRetrieveApplicationFunctionInstance2Request {
	return ApiRetrieveApplicationFunctionInstance2Request{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return FunctionInstanceResponse
func (a *ApplicationsFunctionAPIService) RetrieveApplicationFunctionInstance2Execute(r ApiRetrieveApplicationFunctionInstance2Request) (*FunctionInstanceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsFunctionAPIService.RetrieveApplicationFunctionInstance2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
/*
UpdateApplicationFunctionInstance Update an Application Function Instance
...
type ApiUpdateApplicationFunctionInstance2Request struct {
	ctx context.Context
	ApiService *ApplicationsFunctionAPIService
	applicationId int64
	functionId int64
...
func (r ApiUpdateApplicationFunctionInstance2Request) FunctionInstanceRequest(functionInstanceRequest FunctionInstanceRequest) ApiUpdateApplicationFunctionInstance2Request {
	r.functionInstanceRequest = &functionInstanceRequest
	return r
}

func (r ApiUpdateApplicationFunctionInstance2Request) Execute() (*FunctionInstanceResponse, *http.Response, error) {
	return r.ApiService.UpdateApplicationFunctionInstance2Execute(r)
}

/*
UpdateApplicationFunctionInstance2 Update an Application Function Instance
...
Update an existing Application Function Instance. This replaces the entire Function Instance with the new data provided.
 ...
 @param functionId A unique integer value identifying the function instance.
 @param versionId The ULID identifier of the version.
 @return ApiUpdateApplicationFunctionInstance2Request
*/
func (a *ApplicationsFunctionAPIService) UpdateApplicationFunctionInstance2(ctx context.Context, applicationId int64, functionId int64, versionId string) ApiUpdateApplicationFunctionInstance2Request {
	return ApiUpdateApplicationFunctionInstance2Request{
		ApiService: a,
		ctx: ctx,
		applicationId: applicationId,
...
// Execute executes the request
//  @return FunctionInstanceResponse
func (a *ApplicationsFunctionAPIService) UpdateApplicationFunctionInstance2Execute(r ApiUpdateApplicationFunctionInstance2Request) (*FunctionInstanceResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsFunctionAPIService.UpdateApplicationFunctionInstance2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
