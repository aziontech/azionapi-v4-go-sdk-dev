...
func (src ApplicationCriterionArgumentRequest) MarshalJSON() ([]byte, error) {
	if src.Int64 != nil {
...
func (v NullableApplicationCriterionArgumentRequest) Get() *ApplicationCriterionArgumentRequest {
	return v.value
}

func (v *NullableApplicationCriterionArgumentRequest) Set(val *ApplicationCriterionArgumentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationCriterionArgumentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationCriterionArgumentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationCriterionArgumentRequest(val *ApplicationCriterionArgumentRequest) *NullableApplicationCriterionArgumentRequest {
	return &NullableApplicationCriterionArgumentRequest{value: val, isSet: true}
}

func (v NullableApplicationCriterionArgumentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationCriterionArgumentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
