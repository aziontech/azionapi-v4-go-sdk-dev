...
// checks if the PaginatedFunctionsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedFunctionsList{}

// PaginatedFunctionsList struct for PaginatedFunctionsList
type PaginatedFunctionsList struct {
	...
	Results []Functions `json:"results,omitempty"`
}
...
func (o *PaginatedFunctionsList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedFunctionsList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []Functions and assigns it to the Results field.
func (o *PaginatedFunctionsList) SetResults(v []Functions) {
	o.Results = v
}

func (o PaginatedFunctionsList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedFunctionsList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedFunctionsList struct {
	value *PaginatedFunctionsList
	isSet bool
}

func (v NullablePaginatedFunctionsList) Get() *PaginatedFunctionsList {
	return v.value
}

func (v *NullablePaginatedFunctionsList) Set(val *PaginatedFunctionsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFunctionsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFunctionsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFunctionsList(val *PaginatedFunctionsList) *NullablePaginatedFunctionsList {
	return &NullablePaginatedFunctionsList{value: val, isSet: true}
}

func (v NullablePaginatedFunctionsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFunctionsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
