...
type ApiCreateWafException2Request struct {
	ctx context.Context
	ApiService *WAFsExceptionsAPIService
	versionId string
	wafId int64
...
func (r ApiCreateWafException2Request) WAFRuleRequest(wAFRuleRequest WAFRuleRequest) ApiCreateWafException2Request {
	r.wAFRuleRequest = &wAFRuleRequest
	return r
}

func (r ApiCreateWafException2Request) Execute() (*WAFRuleResponse, *http.Response, error) {
	return r.ApiService.CreateWafException2Execute(r)
}

/*
CreateWafException2 Create an Exception for a Web Application Firewall (WAF)
...
Create a new Exception for a specific WAF in your account.
 ...
 @param wafId A unique integer value identifying the WAF.
 @return ApiCreateWafException2Request
*/
func (a *WAFsExceptionsAPIService) CreateWafException2(ctx context.Context, versionId string, wafId int64) ApiCreateWafException2Request {
	return ApiCreateWafException2Request{
		ApiService: a,
		ctx: ctx,
		versionId: versionId,
...
// Execute executes the request
//  @return WAFRuleResponse
func (a *WAFsExceptionsAPIService) CreateWafException2Execute(r ApiCreateWafException2Request) (*WAFRuleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WAFsExceptionsAPIService.CreateWafException2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/workspace/wafs/{waf_id}/versions/{version_id}/exceptions"
...
type ApiDeleteWafException2Request struct {
	ctx context.Context
	ApiService *WAFsExceptionsAPIService
	exceptionId int64
	versionId string
...
func (r ApiDeleteWafException2Request) Execute() (*DeleteResponse, *http.Response, error) {
	return r.ApiService.DeleteWafException2Execute(r)
}

/*
DeleteWafException2 Delete an Exception from a Web Application Firewall (WAF)
...
Remove a specific Exception from a WAF in your account.
 ...
 @param versionId The ULID identifier of the version.
 @param wafId A unique integer value identifying the WAF.
 @return ApiDeleteWafException2Request
*/
func (a *WAFsExceptionsAPIService) DeleteWafException2(ctx context.Context, exceptionId int64, versionId string, wafId int64) ApiDeleteWafException2Request {
	return ApiDeleteWafException2Request{
		ApiService: a,
		ctx: ctx,
		exceptionId: exceptionId,
...
// Execute executes the request
//  @return DeleteResponse
func (a *WAFsExceptionsAPIService) DeleteWafException2Execute(r ApiDeleteWafException2Request) (*DeleteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WAFsExceptionsAPIService.DeleteWafException2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/workspace/wafs/{waf_id}/versions/{version_id}/exceptions/{exception_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"exception_id"+"}", url.PathEscape(parameterValueToString(r.exceptionId, "exceptionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version_id"+"}", url.PathEscape(parameterValueToString(r.versionId, "versionId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"waf_id"+"}", url.PathEscape(parameterValueToString(r.wafId, "wafId")), -1)
...
type ApiListWafExceptions2Request struct {
	ctx context.Context
	ApiService *WAFsExceptionsAPIService
	versionId string
	wafId int64
...
// Filter by creation date (greater than or equal).
func (r ApiListWafExceptions2Request) CreatedAtGte(createdAtGte time.Time) ApiListWafExceptions2Request {
	r.createdAtGte = &createdAtGte
	return r
}

// Filter by creation date (less than or equal).
func (r ApiListWafExceptions2Request) CreatedAtLte(createdAtLte time.Time) ApiListWafExceptions2Request {
	r.createdAtLte = &createdAtLte
	return r
}

// Filter by description (case-insensitive, partial match).
func (r ApiListWafExceptions2Request) Description(description string) ApiListWafExceptions2Request {
	r.description = &description
	return r
}

// Comma-separated list of field names to include in the response. Nested fields can be accessed using dot notation.
func (r ApiListWafExceptions2Request) Fields(fields string) ApiListWafExceptions2Request {
	r.fields = &fields
	return r
}

// Filter by id (accepts comma-separated values).
func (r ApiListWafExceptions2Request) Id(id int64) ApiListWafExceptions2Request {
	r.id = &id
	return r
}

// Filter by last editor (case-insensitive, partial match).
func (r ApiListWafExceptions2Request) LastEditor(lastEditor string) ApiListWafExceptions2Request {
	r.lastEditor = &lastEditor
	return r
}

// Filter by last modified date (greater than or equal).
func (r ApiListWafExceptions2Request) LastModifiedGte(lastModifiedGte time.Time) ApiListWafExceptions2Request {
	r.lastModifiedGte = &lastModifiedGte
	return r
}

// Filter by last modified date (less than or equal).
func (r ApiListWafExceptions2Request) LastModifiedLte(lastModifiedLte time.Time) ApiListWafExceptions2Request {
	r.lastModifiedLte = &lastModifiedLte
	return r
}

// Which field to use when ordering the results.
func (r ApiListWafExceptions2Request) Ordering(ordering string) ApiListWafExceptions2Request {
	r.ordering = &ordering
	return r
}

// A page number within the paginated result set.
func (r ApiListWafExceptions2Request) Page(page int64) ApiListWafExceptions2Request {
	r.page = &page
	return r
}

// A numeric value that indicates the number of items per page.
func (r ApiListWafExceptions2Request) PageSize(pageSize int64) ApiListWafExceptions2Request {
	r.pageSize = &pageSize
	return r
}

// Filter by path (case-insensitive, partial match).
func (r ApiListWafExceptions2Request) Path(path string) ApiListWafExceptions2Request {
	r.path = &path
	return r
}

// A search term.
func (r ApiListWafExceptions2Request) Search(search string) ApiListWafExceptions2Request {
	r.search = &search
	return r
}

func (r ApiListWafExceptions2Request) Execute() (*PaginatedWAFRuleList, *http.Response, error) {
	return r.ApiService.ListWafExceptions2Execute(r)
}

/*
ListWafExceptions2 List Exceptions for a Web Application Firewall (WAF)
...
List all Exceptions associated with a specific WAF owned by your account.
 ...
 @param versionId The ULID identifier of the version.
 @param wafId A unique integer value identifying the WAF.
 @return ApiListWafExceptions2Request
*/
func (a *WAFsExceptionsAPIService) ListWafExceptions2(ctx context.Context, versionId string, wafId int64) ApiListWafExceptions2Request {
	return ApiListWafExceptions2Request{
		ApiService: a,
		ctx: ctx,
		versionId: versionId,
...
// Execute executes the request
//  @return PaginatedWAFRuleList
func (a *WAFsExceptionsAPIService) ListWafExceptions2Execute(r ApiListWafExceptions2Request) (*PaginatedWAFRuleList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WAFsExceptionsAPIService.ListWafExceptions2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPartialUpdateWafException2Request struct {
	ctx context.Context
	ApiService *WAFsExceptionsAPIService
	exceptionId int64
	versionId string
...
func (r ApiPartialUpdateWafException2Request) PatchedWAFRuleRequest(patchedWAFRuleRequest PatchedWAFRuleRequest) ApiPartialUpdateWafException2Request {
	r.patchedWAFRuleRequest = &patchedWAFRuleRequest
	return r
}

func (r ApiPartialUpdateWafException2Request) Execute() (*WAFRuleResponse, *http.Response, error) {
	return r.ApiService.PartialUpdateWafException2Execute(r)
}

/*
PartialUpdateWafException2 Partially update an Exception for a Web Application Firewall (WAF)
...
Update one or more fields of an existing exception for a WAF without affecting other fields.
 ...
 @param versionId The ULID identifier of the version.
 @param wafId A unique integer value identifying the WAF.
 @return ApiPartialUpdateWafException2Request
*/
func (a *WAFsExceptionsAPIService) PartialUpdateWafException2(ctx context.Context, exceptionId int64, versionId string, wafId int64) ApiPartialUpdateWafException2Request {
	return ApiPartialUpdateWafException2Request{
		ApiService: a,
		ctx: ctx,
		exceptionId: exceptionId,
...
// Execute executes the request
//  @return WAFRuleResponse
func (a *WAFsExceptionsAPIService) PartialUpdateWafException2Execute(r ApiPartialUpdateWafException2Request) (*WAFRuleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WAFsExceptionsAPIService.PartialUpdateWafException2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiRetrieveWafException2Request struct {
	ctx context.Context
	ApiService *WAFsExceptionsAPIService
	exceptionId int64
	versionId string
...
// Comma-separated list of field names to include in the response. Nested fields can be accessed using dot notation.
func (r ApiRetrieveWafException2Request) Fields(fields string) ApiRetrieveWafException2Request {
	r.fields = &fields
	return r
}

func (r ApiRetrieveWafException2Request) Execute() (*WAFRuleResponse, *http.Response, error) {
	return r.ApiService.RetrieveWafException2Execute(r)
}

/*
RetrieveWafException2 Retrieve details of an Exception from a Web Application Firewall (WAF)
...
Retrieve details of a specific Exception from a WAF in your account.
 ...
 @param versionId The ULID identifier of the version.
 @param wafId A unique integer value identifying the WAF.
 @return ApiRetrieveWafException2Request
*/
func (a *WAFsExceptionsAPIService) RetrieveWafException2(ctx context.Context, exceptionId int64, versionId string, wafId int64) ApiRetrieveWafException2Request {
	return ApiRetrieveWafException2Request{
		ApiService: a,
		ctx: ctx,
		exceptionId: exceptionId,
...
// Execute executes the request
//  @return WAFRuleResponse
func (a *WAFsExceptionsAPIService) RetrieveWafException2Execute(r ApiRetrieveWafException2Request) (*WAFRuleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WAFsExceptionsAPIService.RetrieveWafException2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateWafException2Request struct {
	ctx context.Context
	ApiService *WAFsExceptionsAPIService
	exceptionId int64
	versionId string
...
func (r ApiUpdateWafException2Request) WAFRuleRequest(wAFRuleRequest WAFRuleRequest) ApiUpdateWafException2Request {
	r.wAFRuleRequest = &wAFRuleRequest
	return r
}

func (r ApiUpdateWafException2Request) Execute() (*WAFRuleResponse, *http.Response, error) {
	return r.ApiService.UpdateWafException2Execute(r)
}

/*
UpdateWafException2 Update an Exception for a Web Application Firewall (WAF)
...
Update an existing Exception for a WAF. This replaces the entire rule with the new data provided.
 ...
 @param versionId The ULID identifier of the version.
 @param wafId A unique integer value identifying the WAF.
 @return ApiUpdateWafException2Request
*/
func (a *WAFsExceptionsAPIService) UpdateWafException2(ctx context.Context, exceptionId int64, versionId string, wafId int64) ApiUpdateWafException2Request {
	return ApiUpdateWafException2Request{
		ApiService: a,
		ctx: ctx,
		exceptionId: exceptionId,
...
// Execute executes the request
//  @return WAFRuleResponse
func (a *WAFsExceptionsAPIService) UpdateWafException2Execute(r ApiUpdateWafException2Request) (*WAFRuleResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WAFsExceptionsAPIService.UpdateWafException2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
