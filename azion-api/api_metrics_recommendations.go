...
func (a *MetricsRecommendationsAPIService) DeleteRecommendationExecute(r ApiDeleteRecommendationRequest) (*ResponseDeleteRecommendation, *http.Response, error) {
	...
	localVarPath := localBasePath + "/metrics/recommendations/{recommendation_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"recommendation_id"+"}", url.PathEscape(parameterValueToString(r.recommendationId, "recommendationId")), -1)
