...
type _ResponsePaymentMethod ResponsePaymentMethod
...
func (o *ResponsePaymentMethod) UnmarshalJSON(data []byte) (err error) {
	...
	varResponsePaymentMethod := _ResponsePaymentMethod{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponsePaymentMethod)

	if err != nil {
		return err
	}

	*o = ResponsePaymentMethod(varResponsePaymentMethod)
