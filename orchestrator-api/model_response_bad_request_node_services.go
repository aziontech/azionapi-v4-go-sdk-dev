...
// checks if the ResponseBadRequestNodeServices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseBadRequestNodeServices{}

// ResponseBadRequestNodeServices struct for ResponseBadRequestNodeServices
type ResponseBadRequestNodeServices struct {
...
func NewResponseBadRequestNodeServices() *ResponseBadRequestNodeServices {
	this := ResponseBadRequestNodeServices{}
	return &this
}
...
func (o *ResponseBadRequestNodeServices) GetActive() []string {
...
func (o ResponseBadRequestNodeServices) MarshalJSON() ([]byte, error) {
...
func (o ResponseBadRequestNodeServices) ToMap() (map[string]interface{}, error) {
...
type NullableResponseBadRequestNodeServices struct {
	value *ResponseBadRequestNodeServices
	isSet bool
}

func (v NullableResponseBadRequestNodeServices) Get() *ResponseBadRequestNodeServices {
	return v.value
}

func (v *NullableResponseBadRequestNodeServices) Set(val *ResponseBadRequestNodeServices) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseBadRequestNodeServices) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseBadRequestNodeServices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseBadRequestNodeServices(val *ResponseBadRequestNodeServices) *NullableResponseBadRequestNodeServices {
	return &NullableResponseBadRequestNodeServices{value: val, isSet: true}
}

func (v NullableResponseBadRequestNodeServices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseBadRequestNodeServices) UnmarshalJSON(src []byte) error {
	v.isSet = true
