...
type PatchedDataStreamRequest struct {
	...
	Inputs []InputPolymorphicInputDataSourceRequest `json:"inputs,omitempty"`
...
func (o *PatchedDataStreamRequest) GetInputs() []InputPolymorphicInputDataSourceRequest {
	if o == nil || IsNil(o.Inputs) {
		var ret []InputPolymorphicInputDataSourceRequest
		return ret
	}
	return o.Inputs
}
...
// SetInputs gets a reference to the given []InputPolymorphicInputDataSourceRequest and assigns it to the Inputs field.
