...
`func NewDataStream(id int64, name string, lastEditor string, lastModified time.Time, productVersion string, inputs []InputPolymorphicInputDataSource, transform []TransformPolymorphic, outputs []Output, ) *DataStream`
...
`func (o *DataStream) GetInputs() []InputPolymorphicInputDataSource`

GetInputs returns the Inputs field if non-nil, zero value otherwise.

### GetInputsOk

`func (o *DataStream) GetInputsOk() (*[]InputPolymorphicInputDataSource, bool)`
...
`func (o *DataStream) SetInputs(v []InputPolymorphicInputDataSource)`
