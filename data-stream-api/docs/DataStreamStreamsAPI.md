...
func main() {
	dataStreamRequest := *openapiclient.NewDataStreamRequest("Name_example", []openapiclient.InputRequest{*openapiclient.NewInputRequest("Type_example", *openapiclient.NewInputAttributesPolymorphicInputDataSourceRequest("DataSource_example"))}, []openapiclient.TransformRequest{*openapiclient.NewTransformRequest("Type_example", openapiclient.TransformAttributesPolymorphicRequest{TransformAttributesPolymorphicTransformFilterWorkloadsRequest: openapiclient.NewTransformAttributesPolymorphicTransformFilterWorkloadsRequest([]int64{int64(123)})})}, []openapiclient.OutputRequest{*openapiclient.NewOutputRequest("Type_example", openapiclient.OutputPolymorphicRequest{AWSKinesisFirehoseEndpointRequest: openapiclient.NewAWSKinesisFirehoseEndpointRequest("AccessKey_example", "StreamName_example", "Region_example", "SecretKey_example")})}) // DataStreamRequest | 
