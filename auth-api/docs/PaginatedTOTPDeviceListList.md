...
`func (o *PaginatedTOTPDeviceListList) GetNext() string`

GetNext returns the Next field if non-nil, zero value otherwise.

### GetNextOk

`func (o *PaginatedTOTPDeviceListList) GetNextOk() (*string, bool)`
...
`func (o *PaginatedTOTPDeviceListList) SetNext(v string)`

SetNext sets Next field to given value.

### HasNext

`func (o *PaginatedTOTPDeviceListList) HasNext() bool`

HasNext returns a boolean if a field has been set.

### SetNextNil

`func (o *PaginatedTOTPDeviceListList) SetNextNil(b bool)`

 SetNextNil sets the value for Next to be an explicit nil

### UnsetNext
`func (o *PaginatedTOTPDeviceListList) UnsetNext()`

UnsetNext ensures that no value is present for Next, not even an explicit nil
### GetPrevious

`func (o *PaginatedTOTPDeviceListList) GetPrevious() string`

GetPrevious returns the Previous field if non-nil, zero value otherwise.

### GetPreviousOk

`func (o *PaginatedTOTPDeviceListList) GetPreviousOk() (*string, bool)`
...
`func (o *PaginatedTOTPDeviceListList) SetPrevious(v string)`

SetPrevious sets Previous field to given value.

### HasPrevious

`func (o *PaginatedTOTPDeviceListList) HasPrevious() bool`

HasPrevious returns a boolean if a field has been set.

### SetPreviousNil

`func (o *PaginatedTOTPDeviceListList) SetPreviousNil(b bool)`

 SetPreviousNil sets the value for Previous to be an explicit nil

### UnsetPrevious
`func (o *PaginatedTOTPDeviceListList) UnsetPrevious()`
