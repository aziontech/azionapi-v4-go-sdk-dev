...
// checks if the AppCriterionFieldRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppCriterionFieldRequest{}
...
type AppCriterionFieldRequest struct {
	// * `if` - if * `or` - or * `and` - and
	...
	Argument NullableAppCriterionArgumentRequest `json:"argument,omitempty"`
}

type _AppCriterionFieldRequest AppCriterionFieldRequest
...
func (o *AppCriterionFieldRequest) GetArgument() AppCriterionArgumentRequest {
	if o == nil || IsNil(o.Argument.Get()) {
		var ret AppCriterionArgumentRequest
		return ret
	}
...
// SetArgument gets a reference to the given NullableAppCriterionArgumentRequest and assigns it to the Argument field.
...
func (o *AppCriterionFieldRequest) SetArgumentNil() {
	o.Argument.Set(nil)
}
...
func (o AppCriterionFieldRequest) MarshalJSON() ([]byte, error) {
...
func (o AppCriterionFieldRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AppCriterionFieldRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCriterionFieldRequest := _AppCriterionFieldRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCriterionFieldRequest)

	if err != nil {
		return err
	}

	*o = AppCriterionFieldRequest(varAppCriterionFieldRequest)

	return err
}

type NullableAppCriterionFieldRequest struct {
	value *AppCriterionFieldRequest
	isSet bool
}

func (v NullableAppCriterionFieldRequest) Get() *AppCriterionFieldRequest {
	return v.value
}

func (v *NullableAppCriterionFieldRequest) Set(val *AppCriterionFieldRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCriterionFieldRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCriterionFieldRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCriterionFieldRequest(val *AppCriterionFieldRequest) *NullableAppCriterionFieldRequest {
	return &NullableAppCriterionFieldRequest{value: val, isSet: true}
}

func (v NullableAppCriterionFieldRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCriterionFieldRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
