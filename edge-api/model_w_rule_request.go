...
// checks if the WRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WRuleRequest{}

// WRuleRequest struct for WRuleRequest
type WRuleRequest struct {
	...
	Conditions []WExceptionConditionRequest `json:"conditions"`
	// * `regex` - regex * `contains` - contains
	Operator *string `json:"operator,omitempty"`
	Active *bool `json:"active,omitempty"`
}

type _WRuleRequest WRuleRequest
...
func (o *WRuleRequest) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o WRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o WRuleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WRuleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varWRuleRequest := _WRuleRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWRuleRequest)

	if err != nil {
		return err
	}

	*o = WRuleRequest(varWRuleRequest)

	return err
}

type NullableWRuleRequest struct {
	value *WRuleRequest
	isSet bool
}

func (v NullableWRuleRequest) Get() *WRuleRequest {
	return v.value
}

func (v *NullableWRuleRequest) Set(val *WRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWRuleRequest(val *WRuleRequest) *NullableWRuleRequest {
	return &NullableWRuleRequest{value: val, isSet: true}
}

func (v NullableWRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
