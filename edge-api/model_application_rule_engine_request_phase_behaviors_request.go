...
type ApplicationRuleEngineRequestPhaseBehaviorsRequest struct {
	...
	ApplicationRequestPhaseBehaviorNoArgsRequest *ApplicationRequestPhaseBehaviorNoArgsRequest
	...
	ApplicationRequestPhaseBehaviorStringRequest *ApplicationRequestPhaseBehaviorStringRequest
}
...
// ApplicationRequestPhaseBehaviorNoArgsRequestAsApplicationRuleEngineRequestPhaseBehaviorsRequest is a convenience function that returns ApplicationRequestPhaseBehaviorNoArgsRequest wrapped in ApplicationRuleEngineRequestPhaseBehaviorsRequest
func ApplicationRequestPhaseBehaviorNoArgsRequestAsApplicationRuleEngineRequestPhaseBehaviorsRequest(v *ApplicationRequestPhaseBehaviorNoArgsRequest) ApplicationRuleEngineRequestPhaseBehaviorsRequest {
	return ApplicationRuleEngineRequestPhaseBehaviorsRequest{
		ApplicationRequestPhaseBehaviorNoArgsRequest: v,
	}
}
...
// ApplicationRequestPhaseBehaviorStringRequestAsApplicationRuleEngineRequestPhaseBehaviorsRequest is a convenience function that returns ApplicationRequestPhaseBehaviorStringRequest wrapped in ApplicationRuleEngineRequestPhaseBehaviorsRequest
func ApplicationRequestPhaseBehaviorStringRequestAsApplicationRuleEngineRequestPhaseBehaviorsRequest(v *ApplicationRequestPhaseBehaviorStringRequest) ApplicationRuleEngineRequestPhaseBehaviorsRequest {
	return ApplicationRuleEngineRequestPhaseBehaviorsRequest{
		ApplicationRequestPhaseBehaviorStringRequest: v,
	}
}
...
func (dst *ApplicationRuleEngineRequestPhaseBehaviorsRequest) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into ApplicationRequestPhaseBehaviorNoArgsRequest
	err = newStrictDecoder(data).Decode(&dst.ApplicationRequestPhaseBehaviorNoArgsRequest)
	if err == nil {
		jsonApplicationRequestPhaseBehaviorNoArgsRequest, _ := json.Marshal(dst.ApplicationRequestPhaseBehaviorNoArgsRequest)
		if string(jsonApplicationRequestPhaseBehaviorNoArgsRequest) == "{}" { // empty struct
			dst.ApplicationRequestPhaseBehaviorNoArgsRequest = nil
		} else {
			if err = validator.Validate(dst.ApplicationRequestPhaseBehaviorNoArgsRequest); err != nil {
				dst.ApplicationRequestPhaseBehaviorNoArgsRequest = nil
			} else {
				match++
			}
	...
	// try to unmarshal data into ApplicationRequestPhaseBehaviorStringRequest
	err = newStrictDecoder(data).Decode(&dst.ApplicationRequestPhaseBehaviorStringRequest)
	if err == nil {
		jsonApplicationRequestPhaseBehaviorStringRequest, _ := json.Marshal(dst.ApplicationRequestPhaseBehaviorStringRequest)
		if string(jsonApplicationRequestPhaseBehaviorStringRequest) == "{}" { // empty struct
			dst.ApplicationRequestPhaseBehaviorStringRequest = nil
		} else {
			if err = validator.Validate(dst.ApplicationRequestPhaseBehaviorStringRequest); err != nil {
				dst.ApplicationRequestPhaseBehaviorStringRequest = nil
			} else {
				match++
			}
...
func (src ApplicationRuleEngineRequestPhaseBehaviorsRequest) MarshalJSON() ([]byte, error) {
	...
	if src.ApplicationRequestPhaseBehaviorNoArgsRequest != nil {
		return json.Marshal(&src.ApplicationRequestPhaseBehaviorNoArgsRequest)
	}
	...
	if src.ApplicationRequestPhaseBehaviorStringRequest != nil {
		return json.Marshal(&src.ApplicationRequestPhaseBehaviorStringRequest)
	}
...
func (obj *ApplicationRuleEngineRequestPhaseBehaviorsRequest) GetActualInstance() (interface{}) {
	...
	if obj.ApplicationRequestPhaseBehaviorNoArgsRequest != nil {
		return obj.ApplicationRequestPhaseBehaviorNoArgsRequest
	}
	...
	if obj.ApplicationRequestPhaseBehaviorStringRequest != nil {
		return obj.ApplicationRequestPhaseBehaviorStringRequest
	}
