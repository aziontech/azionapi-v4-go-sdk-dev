...
// checks if the PaginatedApplicationReqRuleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedApplicationReqRuleList{}

// PaginatedApplicationReqRuleList struct for PaginatedApplicationReqRuleList
type PaginatedApplicationReqRuleList struct {
	...
	Results []AppReqRule `json:"results,omitempty"`
}
...
func NewPaginatedApplicationReqRuleList() *PaginatedApplicationReqRuleList {
	this := PaginatedApplicationReqRuleList{}
	return &this
}
...
// SetResults gets a reference to the given []AppReqRule and assigns it to the Results field.
func (o *PaginatedApplicationReqRuleList) SetResults(v []AppReqRule) {
	o.Results = v
}

func (o PaginatedApplicationReqRuleList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedApplicationReqRuleList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedApplicationReqRuleList struct {
	value *PaginatedApplicationReqRuleList
	isSet bool
}

func (v NullablePaginatedApplicationReqRuleList) Get() *PaginatedApplicationReqRuleList {
	return v.value
}

func (v *NullablePaginatedApplicationReqRuleList) Set(val *PaginatedApplicationReqRuleList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedApplicationReqRuleList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedApplicationReqRuleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedApplicationReqRuleList(val *PaginatedApplicationReqRuleList) *NullablePaginatedApplicationReqRuleList {
	return &NullablePaginatedApplicationReqRuleList{value: val, isSet: true}
}

func (v NullablePaginatedApplicationReqRuleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedApplicationReqRuleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
