...
// checks if the PaginatedApplicationDeviGroupsList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedApplicationDeviGroupsList{}

// PaginatedApplicationDeviGroupsList struct for PaginatedApplicationDeviGroupsList
type PaginatedApplicationDeviGroupsList struct {
	...
	Results []AppDeviGroups `json:"results,omitempty"`
}
...
func NewPaginatedApplicationDeviGroupsList() *PaginatedApplicationDeviGroupsList {
	this := PaginatedApplicationDeviGroupsList{}
	return &this
}
...
// SetResults gets a reference to the given []AppDeviGroups and assigns it to the Results field.
func (o *PaginatedApplicationDeviGroupsList) SetResults(v []AppDeviGroups) {
	o.Results = v
}

func (o PaginatedApplicationDeviGroupsList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedApplicationDeviGroupsList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedApplicationDeviGroupsList struct {
	value *PaginatedApplicationDeviGroupsList
	isSet bool
}

func (v NullablePaginatedApplicationDeviGroupsList) Get() *PaginatedApplicationDeviGroupsList {
	return v.value
}

func (v *NullablePaginatedApplicationDeviGroupsList) Set(val *PaginatedApplicationDeviGroupsList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedApplicationDeviGroupsList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedApplicationDeviGroupsList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedApplicationDeviGroupsList(val *PaginatedApplicationDeviGroupsList) *NullablePaginatedApplicationDeviGroupsList {
	return &NullablePaginatedApplicationDeviGroupsList{value: val, isSet: true}
}

func (v NullablePaginatedApplicationDeviGroupsList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedApplicationDeviGroupsList) UnmarshalJSON(src []byte) error {
	v.isSet = true
