...
type FwCriterionFieldRequest struct {
	...
	Argument NullableFwCriterionArgumentRequest `json:"argument,omitempty"`
}

type _FwCriterionFieldRequest FwCriterionFieldRequest
...
func (o *FwCriterionFieldRequest) GetArgument() FwCriterionArgumentRequest {
	if o == nil || IsNil(o.Argument.Get()) {
		var ret FwCriterionArgumentRequest
		return ret
	}
...
// SetArgument gets a reference to the given NullableFwCriterionArgumentRequest and assigns it to the Argument field.
...
func (o *FwCriterionFieldRequest) SetArgumentNil() {
	o.Argument.Set(nil)
}
...
func (o FwCriterionFieldRequest) MarshalJSON() ([]byte, error) {
...
func (o FwCriterionFieldRequest) ToMap() (map[string]interface{}, error) {
...
func (o *FwCriterionFieldRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varFwCriterionFieldRequest := _FwCriterionFieldRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFwCriterionFieldRequest)

	if err != nil {
		return err
	}

	*o = FwCriterionFieldRequest(varFwCriterionFieldRequest)

	return err
}

type NullableFwCriterionFieldRequest struct {
	value *FwCriterionFieldRequest
	isSet bool
}

func (v NullableFwCriterionFieldRequest) Get() *FwCriterionFieldRequest {
	return v.value
}

func (v *NullableFwCriterionFieldRequest) Set(val *FwCriterionFieldRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableFwCriterionFieldRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableFwCriterionFieldRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFwCriterionFieldRequest(val *FwCriterionFieldRequest) *NullableFwCriterionFieldRequest {
	return &NullableFwCriterionFieldRequest{value: val, isSet: true}
}

func (v NullableFwCriterionFieldRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFwCriterionFieldRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
