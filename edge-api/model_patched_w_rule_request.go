...
// checks if the PatchedWRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedWRuleRequest{}

// PatchedWRuleRequest struct for PatchedWRuleRequest
type PatchedWRuleRequest struct {
	...
	Conditions []WExceptionConditionRequest `json:"conditions,omitempty"`
...
func (o *PatchedWRuleRequest) SetPathNil() {
	o.Path.Set(nil)
}
...
func (o *PatchedWRuleRequest) GetConditions() []WExceptionConditionRequest {
	if o == nil || IsNil(o.Conditions) {
		var ret []WExceptionConditionRequest
		return ret
	}
	return o.Conditions
}
...
// SetConditions gets a reference to the given []WExceptionConditionRequest and assigns it to the Conditions field.
...
func (o PatchedWRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedWRuleRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePatchedWRuleRequest struct {
	value *PatchedWRuleRequest
	isSet bool
}

func (v NullablePatchedWRuleRequest) Get() *PatchedWRuleRequest {
	return v.value
}

func (v *NullablePatchedWRuleRequest) Set(val *PatchedWRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedWRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedWRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedWRuleRequest(val *PatchedWRuleRequest) *NullablePatchedWRuleRequest {
	return &NullablePatchedWRuleRequest{value: val, isSet: true}
}

func (v NullablePatchedWRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedWRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
