...
// checks if the FwBehaviorRateLimitAttrsReq type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FwBehaviorRateLimitAttrsReq{}

// FwBehaviorRateLimitAttrsReq struct for FwBehaviorRateLimitAttrsReq
type FwBehaviorRateLimitAttrsReq struct {
...
type _FwBehaviorRateLimitAttrsReq FwBehaviorRateLimitAttrsReq
...
func NewFwBehaviorRateLimitAttrsReq(limitBy string, averageRateLimit int64) *FwBehaviorRateLimitAttrsReq {
	this := FwBehaviorRateLimitAttrsReq{}
...
func (o *FwBehaviorRateLimitAttrsReq) SetMaximumBurstSizeNil() {
...
func (o FwBehaviorRateLimitAttrsReq) MarshalJSON() ([]byte, error) {
...
func (o FwBehaviorRateLimitAttrsReq) ToMap() (map[string]interface{}, error) {
...
func (o *FwBehaviorRateLimitAttrsReq) UnmarshalJSON(data []byte) (err error) {
	...
	varFwBehaviorRateLimitAttrsReq := _FwBehaviorRateLimitAttrsReq{}

	err = json.Unmarshal(data, &varFwBehaviorRateLimitAttrsReq)

	if err != nil {
		return err
	}

	*o = FwBehaviorRateLimitAttrsReq(varFwBehaviorRateLimitAttrsReq)
...
type NullableFwBehaviorRateLimitAttrsReq struct {
	value *FwBehaviorRateLimitAttrsReq
	isSet bool
}

func (v NullableFwBehaviorRateLimitAttrsReq) Get() *FwBehaviorRateLimitAttrsReq {
	return v.value
}

func (v *NullableFwBehaviorRateLimitAttrsReq) Set(val *FwBehaviorRateLimitAttrsReq) {
	v.value = val
	v.isSet = true
}

func (v NullableFwBehaviorRateLimitAttrsReq) IsSet() bool {
	return v.isSet
}

func (v *NullableFwBehaviorRateLimitAttrsReq) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFwBehaviorRateLimitAttrsReq(val *FwBehaviorRateLimitAttrsReq) *NullableFwBehaviorRateLimitAttrsReq {
	return &NullableFwBehaviorRateLimitAttrsReq{value: val, isSet: true}
}

func (v NullableFwBehaviorRateLimitAttrsReq) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFwBehaviorRateLimitAttrsReq) UnmarshalJSON(src []byte) error {
	v.isSet = true
