...
func Test_edgeapi_ApplicationsAPIService(t *testing.T) {
	...
	t.Run("Test ApplicationsAPIService DestroyApplication", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var applicationId int64

		resp, httpRes, err := apiClient.ApplicationsAPI.DestroyApplication(context.Background(), applicationId).Execute()
