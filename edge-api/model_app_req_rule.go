...
// checks if the AppReqRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppReqRule{}

// AppReqRule struct for AppReqRule
type AppReqRule struct {
	Id int64 `json:"id"`
	Name string `json:"name"`
	Active *bool `json:"active,omitempty"`
	Criteria [][]AppCriterionField `json:"criteria"`
	Behaviors []ReqBehaviors `json:"behaviors"`
...
func (o AppReqRule) MarshalJSON() ([]byte, error) {
...
func (o AppReqRule) ToMap() (map[string]interface{}, error) {
...
func (o *AppReqRule) UnmarshalJSON(data []byte) (err error) {
	...
	varAppReqRule := _AppReqRule{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppReqRule)

	if err != nil {
		return err
	}

	*o = AppReqRule(varAppReqRule)

	return err
}

type NullableAppReqRule struct {
	value *AppReqRule
	isSet bool
}

func (v NullableAppReqRule) Get() *AppReqRule {
	return v.value
}

func (v *NullableAppReqRule) Set(val *AppReqRule) {
	v.value = val
	v.isSet = true
}

func (v NullableAppReqRule) IsSet() bool {
	return v.isSet
}

func (v *NullableAppReqRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppReqRule(val *AppReqRule) *NullableAppReqRule {
	return &NullableAppReqRule{value: val, isSet: true}
}

func (v NullableAppReqRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppReqRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
