...
// checks if the WRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WRule{}

// WRule struct for WRule
type WRule struct {
	Id int64 `json:"id"`
	...
	Conditions []WExceptionCondition `json:"conditions"`
...
func (o WRule) MarshalJSON() ([]byte, error) {
...
func (o WRule) ToMap() (map[string]interface{}, error) {
...
func (o *WRule) UnmarshalJSON(data []byte) (err error) {
...
type NullableWRule struct {
	value *WRule
	isSet bool
}

func (v NullableWRule) Get() *WRule {
	return v.value
}

func (v *NullableWRule) Set(val *WRule) {
	v.value = val
	v.isSet = true
}

func (v NullableWRule) IsSet() bool {
	return v.isSet
}

func (v *NullableWRule) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWRule(val *WRule) *NullableWRule {
	return &NullableWRule{value: val, isSet: true}
}

func (v NullableWRule) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWRule) UnmarshalJSON(src []byte) error {
	v.isSet = true
