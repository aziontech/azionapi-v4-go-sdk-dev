...
type AppCriterionField struct {
	...
	Argument NullableAppCriterionArgument `json:"argument,omitempty"`
}

type _AppCriterionField AppCriterionField
...
// SetArgument gets a reference to the given NullableAppCriterionArgument and assigns it to the Argument field.
...
func (o *AppCriterionField) SetArgumentNil() {
	o.Argument.Set(nil)
}
...
func (o AppCriterionField) MarshalJSON() ([]byte, error) {
...
func (o AppCriterionField) ToMap() (map[string]interface{}, error) {
...
func (o *AppCriterionField) UnmarshalJSON(data []byte) (err error) {
	...
	varAppCriterionField := _AppCriterionField{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppCriterionField)

	if err != nil {
		return err
	}

	*o = AppCriterionField(varAppCriterionField)

	return err
}

type NullableAppCriterionField struct {
	value *AppCriterionField
	isSet bool
}

func (v NullableAppCriterionField) Get() *AppCriterionField {
	return v.value
}

func (v *NullableAppCriterionField) Set(val *AppCriterionField) {
	v.value = val
	v.isSet = true
}

func (v NullableAppCriterionField) IsSet() bool {
	return v.isSet
}

func (v *NullableAppCriterionField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppCriterionField(val *AppCriterionField) *NullableAppCriterionField {
	return &NullableAppCriterionField{value: val, isSet: true}
}

func (v NullableAppCriterionField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppCriterionField) UnmarshalJSON(src []byte) error {
	v.isSet = true
