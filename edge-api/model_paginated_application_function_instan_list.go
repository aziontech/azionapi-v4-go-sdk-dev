...
// checks if the PaginatedApplicationFunctionInstanList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedApplicationFunctionInstanList{}

// PaginatedApplicationFunctionInstanList struct for PaginatedApplicationFunctionInstanList
type PaginatedApplicationFunctionInstanList struct {
	...
	Results []AppFuncInstance `json:"results,omitempty"`
}
...
func NewPaginatedApplicationFunctionInstanList() *PaginatedApplicationFunctionInstanList {
	this := PaginatedApplicationFunctionInstanList{}
	return &this
}
...
// SetResults gets a reference to the given []AppFuncInstance and assigns it to the Results field.
func (o *PaginatedApplicationFunctionInstanList) SetResults(v []AppFuncInstance) {
	o.Results = v
}

func (o PaginatedApplicationFunctionInstanList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedApplicationFunctionInstanList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedApplicationFunctionInstanList struct {
	value *PaginatedApplicationFunctionInstanList
	isSet bool
}

func (v NullablePaginatedApplicationFunctionInstanList) Get() *PaginatedApplicationFunctionInstanList {
	return v.value
}

func (v *NullablePaginatedApplicationFunctionInstanList) Set(val *PaginatedApplicationFunctionInstanList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedApplicationFunctionInstanList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedApplicationFunctionInstanList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedApplicationFunctionInstanList(val *PaginatedApplicationFunctionInstanList) *NullablePaginatedApplicationFunctionInstanList {
	return &NullablePaginatedApplicationFunctionInstanList{value: val, isSet: true}
}

func (v NullablePaginatedApplicationFunctionInstanList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedApplicationFunctionInstanList) UnmarshalJSON(src []byte) error {
	v.isSet = true
