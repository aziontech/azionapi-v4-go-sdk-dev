...
// checks if the TLSWorkloRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TLSWorkloRequest{}

// TLSWorkloRequest struct for TLSWorkloRequest
type TLSWorkloRequest struct {
...
func (o *TLSWorkloRequest) SetCertificateNil() {
...
func (o *TLSWorkloRequest) SetMinimumVersionNil() {
...
func (o TLSWorkloRequest) MarshalJSON() ([]byte, error) {
...
func (o TLSWorkloRequest) ToMap() (map[string]interface{}, error) {
...
type NullableTLSWorkloRequest struct {
	value *TLSWorkloRequest
	isSet bool
}

func (v NullableTLSWorkloRequest) Get() *TLSWorkloRequest {
	return v.value
}

func (v *NullableTLSWorkloRequest) Set(val *TLSWorkloRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTLSWorkloRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTLSWorkloRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTLSWorkloRequest(val *TLSWorkloRequest) *NullableTLSWorkloRequest {
	return &NullableTLSWorkloRequest{value: val, isSet: true}
}

func (v NullableTLSWorkloRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTLSWorkloRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
