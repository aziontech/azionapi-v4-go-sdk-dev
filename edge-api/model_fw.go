...
// checks if the Fw type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Fw{}

// Fw struct for Fw
type Fw struct {
	Id int64 `json:"id"`
	Name string `json:"name"`
	Modules *FwModules `json:"modules,omitempty"`
...
// SetModules gets a reference to the given FwModules and assigns it to the Modules field.
...
func (o Fw) MarshalJSON() ([]byte, error) {
...
func (o Fw) ToMap() (map[string]interface{}, error) {
...
func (o *Fw) UnmarshalJSON(data []byte) (err error) {
...
type NullableFw struct {
	value *Fw
	isSet bool
}

func (v NullableFw) Get() *Fw {
	return v.value
}

func (v *NullableFw) Set(val *Fw) {
	v.value = val
	v.isSet = true
}

func (v NullableFw) IsSet() bool {
	return v.isSet
}

func (v *NullableFw) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFw(val *Fw) *NullableFw {
	return &NullableFw{value: val, isSet: true}
}

func (v NullableFw) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFw) UnmarshalJSON(src []byte) error {
	v.isSet = true
