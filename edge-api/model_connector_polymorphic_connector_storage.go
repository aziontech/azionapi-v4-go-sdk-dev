...
// checks if the ConnectorPolymorphicConnectorStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorPolymorphicConnectorStorage{}

// ConnectorPolymorphicConnectorStorage struct for ConnectorPolymorphicConnectorStorage
type ConnectorPolymorphicConnectorStorage struct {
...
type _ConnectorPolymorphicConnectorStorage ConnectorPolymorphicConnectorStorage
...
func NewConnectorPolymorphicConnectorStorage(type_ string, id int64, name string, lastEditor string, lastModified time.Time, createdAt time.Time, productVersion string, isVersioned bool, version NullableInt64, versionState NullableString, attributes ConnectorStorageAttributes) *ConnectorPolymorphicConnectorStorage {
	this := ConnectorPolymorphicConnectorStorage{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o ConnectorPolymorphicConnectorStorage) MarshalJSON() ([]byte, error) {
...
func (o ConnectorPolymorphicConnectorStorage) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorPolymorphicConnectorStorage) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectorPolymorphicConnectorStorage := _ConnectorPolymorphicConnectorStorage{}

	err = json.Unmarshal(data, &varConnectorPolymorphicConnectorStorage)

	if err != nil {
		return err
	}

	*o = ConnectorPolymorphicConnectorStorage(varConnectorPolymorphicConnectorStorage)
...
type NullableConnectorPolymorphicConnectorStorage struct {
	value *ConnectorPolymorphicConnectorStorage
	isSet bool
}

func (v NullableConnectorPolymorphicConnectorStorage) Get() *ConnectorPolymorphicConnectorStorage {
	return v.value
}

func (v *NullableConnectorPolymorphicConnectorStorage) Set(val *ConnectorPolymorphicConnectorStorage) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorPolymorphicConnectorStorage) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorPolymorphicConnectorStorage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorPolymorphicConnectorStorage(val *ConnectorPolymorphicConnectorStorage) *NullableConnectorPolymorphicConnectorStorage {
	return &NullableConnectorPolymorphicConnectorStorage{value: val, isSet: true}
}

func (v NullableConnectorPolymorphicConnectorStorage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorPolymorphicConnectorStorage) UnmarshalJSON(src []byte) error {
	v.isSet = true
