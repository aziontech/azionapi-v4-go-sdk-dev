...
// checks if the PaginatedNetworkList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedNetworkList{}

// PaginatedNetworkList struct for PaginatedNetworkList
type PaginatedNetworkList struct {
...
func (o PaginatedNetworkList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedNetworkList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedNetworkList struct {
	value *PaginatedNetworkList
	isSet bool
}

func (v NullablePaginatedNetworkList) Get() *PaginatedNetworkList {
	return v.value
}

func (v *NullablePaginatedNetworkList) Set(val *PaginatedNetworkList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedNetworkList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedNetworkList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedNetworkList(val *PaginatedNetworkList) *NullablePaginatedNetworkList {
	return &NullablePaginatedNetworkList{value: val, isSet: true}
}

func (v NullablePaginatedNetworkList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedNetworkList) UnmarshalJSON(src []byte) error {
	v.isSet = true
