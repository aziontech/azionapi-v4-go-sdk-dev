...
// checks if the PaginatedFirewallFunctionInstanList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedFirewallFunctionInstanList{}

// PaginatedFirewallFunctionInstanList struct for PaginatedFirewallFunctionInstanList
type PaginatedFirewallFunctionInstanList struct {
	...
	Results []FwFuncInstance `json:"results,omitempty"`
}
...
func NewPaginatedFirewallFunctionInstanList() *PaginatedFirewallFunctionInstanList {
	this := PaginatedFirewallFunctionInstanList{}
	return &this
}
...
// SetResults gets a reference to the given []FwFuncInstance and assigns it to the Results field.
func (o *PaginatedFirewallFunctionInstanList) SetResults(v []FwFuncInstance) {
	o.Results = v
}

func (o PaginatedFirewallFunctionInstanList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedFirewallFunctionInstanList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedFirewallFunctionInstanList struct {
	value *PaginatedFirewallFunctionInstanList
	isSet bool
}

func (v NullablePaginatedFirewallFunctionInstanList) Get() *PaginatedFirewallFunctionInstanList {
	return v.value
}

func (v *NullablePaginatedFirewallFunctionInstanList) Set(val *PaginatedFirewallFunctionInstanList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedFirewallFunctionInstanList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedFirewallFunctionInstanList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedFirewallFunctionInstanList(val *PaginatedFirewallFunctionInstanList) *NullablePaginatedFirewallFunctionInstanList {
	return &NullablePaginatedFirewallFunctionInstanList{value: val, isSet: true}
}

func (v NullablePaginatedFirewallFunctionInstanList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedFirewallFunctionInstanList) UnmarshalJSON(src []byte) error {
	v.isSet = true
