...
// checks if the ConnectorPolymorphicConnector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectorPolymorphicConnector{}

// ConnectorPolymorphicConnector struct for ConnectorPolymorphicConnector
type ConnectorPolymorphicConnector struct {
...
type _ConnectorPolymorphicConnector ConnectorPolymorphicConnector
...
func NewConnectorPolymorphicConnector(type_ string, id int64, name string, lastEditor string, lastModified time.Time, createdAt time.Time, productVersion string, isVersioned bool, version NullableInt64, versionState NullableString, attributes ConnectorStorageAttributes) *ConnectorPolymorphicConnector {
	this := ConnectorPolymorphicConnector{}
	this.Type = type_
	this.Id = id
	this.Name = name
...
func (o ConnectorPolymorphicConnector) MarshalJSON() ([]byte, error) {
...
func (o ConnectorPolymorphicConnector) ToMap() (map[string]interface{}, error) {
...
func (o *ConnectorPolymorphicConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varConnectorPolymorphicConnector := _ConnectorPolymorphicConnector{}

	err = json.Unmarshal(data, &varConnectorPolymorphicConnector)

	if err != nil {
		return err
	}

	*o = ConnectorPolymorphicConnector(varConnectorPolymorphicConnector)
...
type NullableConnectorPolymorphicConnector struct {
	value *ConnectorPolymorphicConnector
	isSet bool
}

func (v NullableConnectorPolymorphicConnector) Get() *ConnectorPolymorphicConnector {
	return v.value
}

func (v *NullableConnectorPolymorphicConnector) Set(val *ConnectorPolymorphicConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectorPolymorphicConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectorPolymorphicConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectorPolymorphicConnector(val *ConnectorPolymorphicConnector) *NullableConnectorPolymorphicConnector {
	return &NullableConnectorPolymorphicConnector{value: val, isSet: true}
}

func (v NullableConnectorPolymorphicConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectorPolymorphicConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true
