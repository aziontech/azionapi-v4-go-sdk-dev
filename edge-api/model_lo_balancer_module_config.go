...
// checks if the LoBalancerModuleConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoBalancerModuleConfig{}

// LoBalancerModuleConfig struct for LoBalancerModuleConfig
type LoBalancerModuleConfig struct {
...
func (o LoBalancerModuleConfig) MarshalJSON() ([]byte, error) {
...
func (o LoBalancerModuleConfig) ToMap() (map[string]interface{}, error) {
...
type NullableLoBalancerModuleConfig struct {
	value *LoBalancerModuleConfig
	isSet bool
}

func (v NullableLoBalancerModuleConfig) Get() *LoBalancerModuleConfig {
	return v.value
}

func (v *NullableLoBalancerModuleConfig) Set(val *LoBalancerModuleConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableLoBalancerModuleConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableLoBalancerModuleConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoBalancerModuleConfig(val *LoBalancerModuleConfig) *NullableLoBalancerModuleConfig {
	return &NullableLoBalancerModuleConfig{value: val, isSet: true}
}

func (v NullableLoBalancerModuleConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoBalancerModuleConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
