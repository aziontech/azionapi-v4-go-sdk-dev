...
> RequestPhaseRuleResponse PartialUpdateApplicationRequestRule2(ctx, applicationId, requestRuleId, versionId).PatchedRequestPhaseRuleRequest(patchedRequestPhaseRuleRequest).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ApplicationsRequestRulesAPI.PartialUpdateApplicationRequestRule2(context.Background(), applicationId, requestRuleId, versionId).PatchedRequestPhaseRuleRequest(patchedRequestPhaseRuleRequest).Execute()
	if err != nil {
...
> PaginatedRequestPhaseRuleList UpdateApplicationRequestRulesOrder2(ctx, applicationId, versionId).ApplicationRequestPhaseRuleEngineOrderRequest(applicationRequestPhaseRuleEngineOrderRequest).Search(search).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ApplicationsRequestRulesAPI.UpdateApplicationRequestRulesOrder2(context.Background(), applicationId, versionId).ApplicationRequestPhaseRuleEngineOrderRequest(applicationRequestPhaseRuleEngineOrderRequest).Search(search).Execute()
	if err != nil {
