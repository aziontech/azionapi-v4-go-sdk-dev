...
`func NewPatchedConnectorPolymorphicRequest(type_ string, name string, attributes ConnectorLiveIngestAttributesRequest, ) *PatchedConnectorPolymorphicRequest`
