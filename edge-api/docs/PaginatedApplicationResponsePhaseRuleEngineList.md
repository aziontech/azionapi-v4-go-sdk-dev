...
`func (o *PaginatedApplicationResponsePhaseRuleEngineList) GetTotalPages() int64`

GetTotalPages returns the TotalPages field if non-nil, zero value otherwise.

### GetTotalPagesOk

`func (o *PaginatedApplicationResponsePhaseRuleEngineList) GetTotalPagesOk() (*int64, bool)`
...
`func (o *PaginatedApplicationResponsePhaseRuleEngineList) SetTotalPages(v int64)`
...
`func (o *PaginatedApplicationResponsePhaseRuleEngineList) GetPage() int64`

GetPage returns the Page field if non-nil, zero value otherwise.

### GetPageOk

`func (o *PaginatedApplicationResponsePhaseRuleEngineList) GetPageOk() (*int64, bool)`
...
`func (o *PaginatedApplicationResponsePhaseRuleEngineList) SetPage(v int64)`
...
`func (o *PaginatedApplicationResponsePhaseRuleEngineList) GetPageSize() int64`

GetPageSize returns the PageSize field if non-nil, zero value otherwise.

### GetPageSizeOk

`func (o *PaginatedApplicationResponsePhaseRuleEngineList) GetPageSizeOk() (*int64, bool)`
...
`func (o *PaginatedApplicationResponsePhaseRuleEngineList) SetPageSize(v int64)`
