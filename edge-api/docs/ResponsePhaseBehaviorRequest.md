...
`func NewResponsePhaseBehaviorRequest(type_ string, attributes BehaviorCaptureMatchGroupsAttributes, ) *ResponsePhaseBehaviorRequest`
...
`func (o *ResponsePhaseBehaviorRequest) GetAttributes() BehaviorCaptureMatchGroupsAttributes`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *ResponsePhaseBehaviorRequest) GetAttributesOk() (*BehaviorCaptureMatchGroupsAttributes, bool)`
...
`func (o *ResponsePhaseBehaviorRequest) SetAttributes(v BehaviorCaptureMatchGroupsAttributes)`
