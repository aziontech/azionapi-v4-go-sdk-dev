...
`func NewFirewallRule(id int64, name string, lastEditor string, lastModified time.Time, createdAt time.Time, criteria [][]EdgeFirewallCriterionField, behaviors []FirewallBehavior, order int64, ) *FirewallRule`
