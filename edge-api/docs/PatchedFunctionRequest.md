...
`func (o *PatchedFunctionRequest) GetAzionForm() EdgeFunctionAzionForm`

GetAzionForm returns the AzionForm field if non-nil, zero value otherwise.

### GetAzionFormOk

`func (o *PatchedFunctionRequest) GetAzionFormOk() (*EdgeFunctionAzionForm, bool)`
...
`func (o *PatchedFunctionRequest) SetAzionForm(v EdgeFunctionAzionForm)`
