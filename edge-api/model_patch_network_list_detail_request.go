...
func NewPatchNetworkListDetailRequest() *PatchNetworkListDetailRequest {
	this := PatchNetworkListDetailRequest{}
	return &this
}
...
func (o PatchNetworkListDetailRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchNetworkListDetailRequest) ToMap() (map[string]interface{}, error) {
...
type NullablePatchNetworkListDetailRequest struct {
	value *PatchNetworkListDetailRequest
	isSet bool
}

func (v NullablePatchNetworkListDetailRequest) Get() *PatchNetworkListDetailRequest {
	return v.value
}

func (v *NullablePatchNetworkListDetailRequest) Set(val *PatchNetworkListDetailRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchNetworkListDetailRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchNetworkListDetailRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchNetworkListDetailRequest(val *PatchNetworkListDetailRequest) *NullablePatchNetworkListDetailRequest {
	return &NullablePatchNetworkListDetailRequest{value: val, isSet: true}
}

func (v NullablePatchNetworkListDetailRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchNetworkListDetailRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
